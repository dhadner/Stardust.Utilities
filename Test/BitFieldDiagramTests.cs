...
public partial struct DiagramTestRegister
{
    ...
    [BitField(2, End = 4, Description = "Operating mode")] public partial byte Mode { get; set; }
    [BitField(5, End = 6)] public partial byte Priority { get; set; }
...
{
    [BitField(0, End = 3, Description = "Type code")] public partial byte TypeCode { get; set; }
    // bits 4-11 undefined
...
public partial record struct DiagramMsbView
{
    ...
    [BitField(4, End = 7, Description = "Header length")] public partial byte Ihl { get; set; }
    [BitField(16, End = 31, Description = "Total length")] public partial ushort TotalLength { get; set; }
}

[BitFields(typeof(uint))]
public partial struct DiagramWideRegister
{
    [BitField(0, End = 15, Description = "Low half")] public partial ushort LowHalf { get; set; }
    [BitField(16, End = 31, Description = "High half")] public partial ushort HighHalf { get; set; }
}
...
{
    [BitField(4, End = 7, Description = "Device address")] public partial byte Address { get; set; }
    [BitField(2, End = 3, Description = "Command code")] public partial byte Command { get; set; }
    [BitField(0, End = 1, Description = "Register select")] public partial byte Register { get; set; }
    [BitField(0, End = 3, Description = "Extended command (when Command=0)")] public partial byte ExtendedCommand { get; set; }
}
...
{
    [BitField(0, End = 3, Description = "Mode A interpretation")] public partial byte ModeA { get; set; }
    [BitField(0, End = 3, Description = "Mode B interpretation")] public partial byte ModeB { get; set; }
