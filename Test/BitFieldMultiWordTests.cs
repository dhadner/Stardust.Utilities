...
public partial class BitFieldMultiWordTests
{
    ...
    {
        [BitField(0, End = 63)] public partial ulong Word0 { get; set; }    // bits 0-63
        [BitField(64, End = 127)] public partial ulong Word1 { get; set; }  // bits 64-127
        [BitField(128, End = 191)] public partial ulong Word2 { get; set; } // bits 128-191
        [BitFlag(192)] public partial bool Valid { get; set; }         // bit 192
        [BitField(193, End = 199)] public partial byte Tag { get; set; }    // bits 193-199 (7 bits)
    }
    ...
    {
        [BitField(60, End = 67)] public partial byte CrossField { get; set; }  // bits 60-67 (spans words 0-1)
    ...
    public partial struct Bits512
    {
        [BitField(0, End = 63)] public partial ulong W0 { get; set; }
        [BitField(64, End = 127)] public partial ulong W1 { get; set; }
        [BitField(448, End = 511)] public partial ulong W7 { get; set; }
    ...
    {
        [BitField(0, End = 31)] public partial uint Low { get; set; }   // bits 0-31
    ...
    {
        [BitField(0, End = 63)] public partial ulong Low { get; set; }   // bits 0-63
        [BitField(64, End = 71)] public partial byte High { get; set; }   // bits 64-71
    }
    ...
    public partial struct Bits80
    {
        ...
        [BitField(64, End = 79)] public partial ushort High { get; set; }
    }
    ...
    {
        [BitField(0, End = 63)] public partial ulong Low { get; set; }
        [BitField(64, End = 95)] public partial uint High { get; set; }
    }
    ...
    {
        [BitField(0, End = 63)] public partial ulong W0 { get; set; }          // first word
        [BitField(8128, End = 8191)] public partial ulong WMid { get; set; }   // middle word (word 127)
        [BitField(16320, End = 16383)] public partial ulong WLast { get; set; }// last word (word 255)
        [BitFlag(0)] public partial bool LowBit { get; set; }            // bit 0
    ...
    {
        [BitField(0, End = 63, Description = "Lower half")] public partial ulong Low { get; set; }
        [BitField(64, End = 127, Description = "Upper half")] public partial ulong High { get; set; }
    }
