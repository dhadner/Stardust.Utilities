...
/// record struct views (deprecated [BitFields]) and [BitFields] structs.
///
/// Coverage matrix:
///
...
///     4. (LE, BitZeroIsMsb) with *Be overrides
///
///   BitFields (2 BitOrder values, endian property types):
///     5. BitZeroIsLsb (default) with *Be and *Le property types
///     6. BitZeroIsMsb with *Be and *Le property types
/// </summary>
public partial class EndianOverrideTests
{
    // ================================================================
    // View struct definitions (deprecated [BitFields]) � all four ByteOrder � BitOrder
    // combos, each with opposite-endian overrides + same-endian explicit
    // ================================================================

    // --- Combo 1: BigEndian / BitZeroIsMsb, with *Le overrides ---

    [BitFields(ByteOrder.BigEndian, BitOrder.BitZeroIsMsb)]
    public partial record struct View_BE_Msb
    {
        [BitField(0, End = 15)]   public partial ushort    NativeU16 { get; set; }  // BE (struct default)
        [BitField(16, End = 47)]  public partial UInt32Le  LeU32     { get; set; }  // LE override
        [BitField(48, End = 63)]  public partial Int16Le   LeS16     { get; set; }  // LE override (signed)
        [BitField(64, End = 127)] public partial UInt64Le  LeU64     { get; set; }  // LE override (64-bit)
    }

    // --- Combo 2: BigEndian / BitZeroIsLsb, with *Le overrides ---

    [BitFields(ByteOrder.BigEndian, BitOrder.BitZeroIsLsb)]
    ...
    {
        [BitField(0, End = 15)]   public partial ushort    NativeU16 { get; set; }  // LE (struct default)
        [BitField(16, End = 47)]  public partial UInt32Be  BeU32     { get; set; }  // BE override
        [BitField(48, End = 63)]  public partial Int16Be   BeS16     { get; set; }  // BE override (signed)
        [BitField(64, End = 127)] public partial UInt64Be  BeU64     { get; set; }  // BE override (64-bit)
    }

    // --- Combo 4: LittleEndian / BitZeroIsMsb, with *Be overrides ---

    [BitFields(ByteOrder.LittleEndian, BitOrder.BitZeroIsMsb)]
    ...
    // --- BitFields with default BitZeroIsLsb, endian property types ---

    [BitFields(typeof(ulong))]
    public partial struct Reg_Lsb
    {
        [BitField(0, End = 15)]  public partial UInt16Be BeU16 { get; set; }
        [BitField(16, End = 31)] public partial UInt16Le LeU16 { get; set; }
        [BitField(32, End = 63)] public partial UInt32Be BeU32 { get; set; }
    }
    ...
    public void View_BE_Msb_NativeField_WritesBigEndian()
    {
        ...
        // BE/BitZeroIsMsb: MSB first -> [0x12, 0x34]
    ...
    #region BitFields (BitZeroIsMsb) with endian property types
    ...
    #region BitFields: BitZeroIsLsb vs BitZeroIsMsb produce same logical values
    ...
    {
        [BitField(0, End = 15)]  public partial ushort    NativeU16 { get; set; }
        [BitField(16, End = 31)] public partial UInt16Be  ExplicitU16 { get; set; }
    }
    ...
    {
        [BitField(0, End = 15)]  public partial ushort    NativeU16 { get; set; }
        [BitField(16, End = 31)] public partial UInt16Le  ExplicitU16 { get; set; }
    }
