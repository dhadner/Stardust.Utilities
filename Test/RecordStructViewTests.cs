...
/// <summary>
/// Unit tests for [BitFields]-generated record struct views.
/// Covers big-endian/MSB-first (network convention)
/// and little-endian/LSB-first (default).
/// </summary>
public partial class RecordStructViewTests
{
    ...
    {
        [BitField(0, End = 15)] public partial ushort FullWord { get; set; }
        [BitField(0, End = 7)] public partial byte HighByte { get; set; }
        [BitField(8, End = 15)] public partial byte LowByte { get; set; }
    }

    /// <summary>
    /// Tests nesting a [BitFields] type inside a [BitFields].
    ...
    {
        [BitField(0, End = 7)] public partial EmbeddedFlags Flags { get; set; }
    ...
    {
        [BitField(0, End = 15)] public partial ProtocolHeader16 Header { get; set; }
        [BitField(16, End = 23)] public partial byte Tag { get; set; }
    }
    ...
    {
        [BitField(0, End = 7)] public partial ProtocolHeader16 TruncatedHeader { get; set; }
        [BitField(8, End = 15)] public partial byte Other { get; set; }
    }
    ...
    {
        [BitField(0, End = 15)] public partial StatusFlags WideFlags { get; set; }
        [BitField(16, End = 23)] public partial byte Payload { get; set; }
    }

    /// <summary>
    /// Tests [BitFields] with BitZeroIsMsb bit ordering.
    /// </summary>
    [BitFields(typeof(byte), bitOrder: BitOrder.BitZeroIsMsb)]
    public partial struct BitZeroIsMsbRegister
    {
        [BitField(0, End = 3)] public partial byte HighNibble { get; set; }
        [BitField(4, End = 7)] public partial byte LowNibble { get; set; }
        [BitFlag(0)] public partial bool MsbFlag { get; set; }
        [BitFlag(7)] public partial bool LsbFlag { get; set; }
    }
    ...
    {
        [BitField(0, End = 7)] public partial byte FieldA { get; set; }
    ...
    public partial record struct OuterByteAligned
    {
        ...
        [BitField(16, End = 23)] public partial InnerView Inner { get; set; }
    }
    ...
    public partial record struct OuterBitOffset
    {
        ...
        [BitField(4, End = 11)] public partial InnerView Inner { get; set; }
    }
    ...
    {
        [BitField(0, End = 7)] public partial byte FirstByte { get; set; }
        [BitField(12, End = 19)] public partial InnerView Inner { get; set; }
    }
    ...
    {
        [BitField(0, End = 7)] public partial byte Header { get; set; }
        [BitField(16, End = 23)] public partial InnerViewBE Inner { get; set; }
    }
    ...
    {
        [BitField(0, End = 15)]  public partial ushort LeField { get; set; }
        [BitField(16, End = 47)] public partial UInt32Be BeField { get; set; }
        [BitField(48, End = 63)] public partial UInt16Le ExplicitLeField { get; set; }
    }
    ...
    {
        [BitField(0, End = 15)]  public partial ushort BeField { get; set; }
        [BitField(16, End = 47)] public partial UInt32Le LeField { get; set; }
    }
    ...
    {
        [BitField(0, End = 15)]   public partial UInt16Le U16 { get; set; }
        [BitField(16, End = 31)]  public partial Int16Le  S16 { get; set; }
        [BitField(32, End = 63)]  public partial UInt32Le U32 { get; set; }
        [BitField(64, End = 95)]  public partial Int32Le  S32 { get; set; }
        [BitField(96, End = 159)] public partial UInt64Le U64 { get; set; }
        [BitField(160, End = 223)] public partial Int64Le S64 { get; set; }
    }
    ...
    {
        [BitField(0, End = 15)]    public partial UInt16Be U16 { get; set; }
        [BitField(16, End = 31)]   public partial Int16Be  S16 { get; set; }
        [BitField(32, End = 63)]   public partial UInt32Be U32 { get; set; }
        [BitField(64, End = 95)]   public partial Int32Be  S32 { get; set; }
        [BitField(96, End = 159)]  public partial UInt64Be U64 { get; set; }
        [BitField(160, End = 223)] public partial Int64Be  S64 { get; set; }
    }
    ...
    {
        [BitField(0, End = 15)]    public partial ushort UShortField { get; set; }
        [BitField(16, End = 31)]   public partial short ShortField { get; set; }
        [BitField(32, End = 63)]   public partial uint UIntField { get; set; }
        [BitField(64, End = 95)]   public partial int IntField { get; set; }
        [BitField(96, End = 159)]  public partial ulong ULongField { get; set; }
        [BitField(160, End = 223)] public partial long LongField { get; set; }
    }
    ...
    {
        [BitField(0, End = 2)]  public partial byte ThreeBit { get; set; }  // max 7
        [BitField(3, End = 3)]  public partial byte OneBit { get; set; }    // max 1
        [BitField(4, End = 7)]  public partial byte FourBit { get; set; }   // max 15
    }
    ...
    {
        [BitField(0, End = 3)]   public partial byte N0 { get; set; }
        [BitField(4, End = 7)]   public partial byte N1 { get; set; }
        [BitField(8, End = 11)]  public partial byte N2 { get; set; }
        [BitField(12, End = 15)] public partial byte N3 { get; set; }
    }
    ...
    {
        [BitField(0, End = 0)] public partial byte Bit0 { get; set; }
        [BitField(1, End = 1)] public partial byte Bit1 { get; set; }
        [BitField(2, End = 7)] public partial byte Rest { get; set; }
    }
    ...
    {
        [BitField(0, End = 7)]  public partial short Narrow8 { get; set; }  // 8 bits in a 16-bit type
        [BitField(8, End = 23)] public partial short Full16 { get; set; }   // 16 bits -- sign works here
    }
    ...
    {
        [BitField(0, End = 15)] public partial UInt32Be WideTypeNarrowField { get; set; }
        [BitField(16, End = 31)] public partial ushort Neighbor { get; set; }
    }
    ...
    {
        [BitField(0, End = 63)] public partial ulong Value { get; set; }
    }
    ...
    {
        [BitField(0, End = 7)]     public partial byte First { get; set; }
        [BitField(800, End = 815)] public partial ushort Distant { get; set; }
    }
    ...
    {
        [BitField(0, End = 159)]   public partial IPv4HeaderView Ip { get; set; }
        [BitField(160, End = 223)] public partial UdpHeaderView Udp { get; set; }
    }
    ...
    [Fact]
    public void BitZeroIsMsb_Flag0_Is_MSB()
    {
    ...
    [Fact]
    public void BitZeroIsMsb_Flag7_Is_LSB()
    {
    ...
    [Fact]
    public void BitZeroIsMsb_SetFlags()
    {
        var data = new byte[1];
        var view = new ByteFlagsView(data);
        view.MsbFlag = true;
    ...
    [Fact]
    public void BitZeroIsMsb_MiddleField()
    {
    ...
    [Fact]
    public void BitZeroIsLsb_Flag0_Is_LSB()
    {
    ...
    [Fact]
    public void BitZeroIsLsb_Flag7_Is_MSB()
    {
    ...
    [Fact]
    public void BitZeroIsLsb_MiddleField()
    {
    ...
    #region BitFields BitZeroIsMsb Tests

    [Fact]
    public void BitFields_BitZeroIsMsb_HighNibble()
    {
        // [BitField(0, End = 3)] with BitZeroIsMsb means top 4 bits
    ...
    {
        // [BitField(4, End = 7)] with BitZeroIsMsb means bottom 4 bits
        BitZeroIsMsbRegister reg = 0x05;
        reg.LowNibble.Should().Be(0x05);
    }

    [Fact]
    public void BitFields_BitZeroIsMsb_SetHighNibble()
    {
        BitZeroIsMsbRegister reg = 0;
        reg.HighNibble = 0x0F;
        ((byte)reg).Should().Be(0xF0);
    }

    [Fact]
    public void BitFields_BitZeroIsMsb_SetLowNibble()
    {
        BitZeroIsMsbRegister reg = 0;
        reg.LowNibble = 0x0A;
    ...
    [Fact]
    public void BitFields_BitZeroIsMsb_MsbFlag()
    {
        // [BitFlag(0)] with BitZeroIsMsb = MSB = bit 7 in physical terms = 0x80
        BitZeroIsMsbRegister reg = 0x80;
        reg.MsbFlag.Should().BeTrue();
        reg.LsbFlag.Should().BeFalse();
    }

    [Fact]
    public void BitFields_BitZeroIsMsb_LsbFlag()
    {
        // [BitFlag(7)] with BitZeroIsMsb = LSB = bit 0 in physical terms = 0x01
        BitZeroIsMsbRegister reg = 0x01;
        reg.MsbFlag.Should().BeFalse();
        reg.LsbFlag.Should().BeTrue();
    }

    [Fact]
    public void BitFields_BitZeroIsMsb_RoundTrip()
    {
        BitZeroIsMsbRegister reg = 0;
        reg.HighNibble = 0x0C;
        reg.LowNibble = 0x03;
