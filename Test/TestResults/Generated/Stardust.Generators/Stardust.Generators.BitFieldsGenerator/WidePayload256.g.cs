...
[JsonConverter(typeof(WidePayload256JsonConverter))]
public partial struct WidePayload256 : IComparable, IComparable<WidePayload256>, IEquatable<WidePayload256>,
                             IFormattable, ISpanFormattable, IParsable<WidePayload256>, ISpanParsable<WidePayload256>
{
    ...
    /// <summary>Returns a WidePayload256 with all bits set to zero.</summary>
    public static WidePayload256 Zero => default;
    ...
    public WidePayload256(ulong lower, ulong midLower, ulong midUpper, ulong upper)
    {
        __w0 = lower;
        __w1 = midLower;
        __w2 = midUpper;
    ...
    /// <summary>Creates a new WidePayload256 from a ulong value (zero-extended).</summary>
    public WidePayload256(ulong value) : this(value, 0UL, 0UL, 0UL) { }

    /// <summary>Creates a new WidePayload256 from an int value. Negative values are sign-extended
    /// to all 256 bits (e.g., -1 sets all bits to 1).</summary>
    public WidePayload256(int value)
    {
    ...
    /// <summary>Returns a WidePayload256 with the mask for the Word0 field (bits 0-63).</summary>
    public static WidePayload256 Word0Mask => new(0xFFFFFFFFFFFFFFFFUL, 0UL, 0UL, 0UL);

    /// <summary>Returns a WidePayload256 with the mask for the Word1 field (bits 64-127).</summary>
    public static WidePayload256 Word1Mask => new(0UL, 0xFFFFFFFFFFFFFFFFUL, 0UL, 0UL);

    /// <summary>Returns a WidePayload256 with the mask for the Word2 field (bits 128-191).</summary>
    public static WidePayload256 Word2Mask => new(0UL, 0UL, 0xFFFFFFFFFFFFFFFFUL, 0UL);

    /// <summary>Returns a WidePayload256 with the mask for the Word3 field (bits 192-255).</summary>
    public static WidePayload256 Word3Mask => new(0UL, 0UL, 0UL, 0xFFFFFFFFFFFFFFFFUL);

    /// <summary>Returns a new WidePayload256 with the Word0 field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public WidePayload256 WithWord0(ulong value) { var copy = this; copy.Word0 = value; return copy; }

    /// <summary>Returns a new WidePayload256 with the Word1 field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public WidePayload256 WithWord1(ulong value) { var copy = this; copy.Word1 = value; return copy; }

    /// <summary>Returns a new WidePayload256 with the Word2 field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public WidePayload256 WithWord2(ulong value) { var copy = this; copy.Word2 = value; return copy; }

    /// <summary>Returns a new WidePayload256 with the Word3 field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public WidePayload256 WithWord3(ulong value) { var copy = this; copy.Word3 = value; return copy; }
    ...
    {
        new("Word0", 0, 64, "ulong", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 256, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        new("Word1", 64, 64, "ulong", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 256, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        new("Word2", 128, 64, "ulong", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 256, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        new("Word3", 192, 64, "ulong", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 256, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
    };

    /// <summary>Bitwise complement operator.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WidePayload256 operator ~(WidePayload256 a) => new(~a.__w0, ~a.__w1, ~a.__w2, ~a.__w3);

    /// <summary>Bitwise OR operator.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WidePayload256 operator |(WidePayload256 a, WidePayload256 b) => new(a.__w0 | b.__w0, a.__w1 | b.__w1, a.__w2 | b.__w2, a.__w3 | b.__w3);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WidePayload256 operator &(WidePayload256 a, ulong b) => new(a.__w0 & b, 0UL, 0UL, 0UL);

    /// <summary>Unary plus operator.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WidePayload256 operator +(WidePayload256 a) => a;

    /// <summary>Unary negation operator. Returns two's complement negation.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WidePayload256 operator -(WidePayload256 a) => ~a + new WidePayload256(1UL);

    /// <summary>Addition operator with carry propagation.</summary>
    public static WidePayload256 operator +(WidePayload256 a, WidePayload256 b)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WidePayload256 operator +(WidePayload256 a, ulong b) => a + new WidePayload256(b);
    ...
    public static WidePayload256 operator *(WidePayload256 a, WidePayload256 b) => FromBigInteger(a.ToBigInteger() * b.ToBigInteger());

    /// <summary>Multiplication operator with ulong.</summary>
    public static WidePayload256 operator *(WidePayload256 a, ulong b) => FromBigInteger(a.ToBigInteger() * b);

    /// <summary>Multiplication operator with ulong.</summary>
    public static WidePayload256 operator *(ulong a, WidePayload256 b) => FromBigInteger(a * b.ToBigInteger());
    ...
    public static WidePayload256 operator <<(WidePayload256 a, int amount)
    {
        if (amount <= 0) return a;
        if (amount >= __TOTAL_BITS) return default;
        int wordShift = amount / 64;
        int bitShift = amount % 64;
        var result = default(WidePayload256);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WidePayload256 operator >>>(WidePayload256 a, int amount) => a >> amount;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static ulong GetWord(WidePayload256 v, int index)
    {
        return index switch
        {
            0 => v.__w0,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static void SetWord(ref WidePayload256 v, int index, ulong value)
    {
        switch (index)
        {
    ...
    public static bool operator <(WidePayload256 a, WidePayload256 b)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator >(WidePayload256 a, WidePayload256 b) => b < a;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(WidePayload256 a, WidePayload256 b) => a.__w0 == b.__w0 && a.__w1 == b.__w1 && a.__w2 == b.__w2 && a.__w3 == b.__w3;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator WidePayload256(ulong value) => new(value);

    /// <summary>Implicit conversion from int.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator WidePayload256(int value) => new(value);

    /// <summary>Explicit conversion to BigInteger.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator BigInteger(WidePayload256 value) => value.ToBigInteger();
    ...
    /// <summary>Creates a WidePayload256 from a BigInteger (truncated to 256 bits).</summary>
    public static WidePayload256 FromBigInteger(BigInteger value)
    {
    ...
    /// <summary>Creates a new WidePayload256 from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    /// <exception cref="ArgumentException">The span is too short.</exception>
    public WidePayload256(ReadOnlySpan<byte> bytes)
    {
    ...
    /// <summary>Creates a new WidePayload256 by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    /// <returns>The deserialized WidePayload256.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WidePayload256 ReadFrom(ReadOnlySpan<byte> bytes) => new(bytes);
    ...
    /// <summary>Parses a string into a WidePayload256. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    public static WidePayload256 Parse(string s, IFormatProvider? provider)
    {
    ...
    /// <summary>Tries to parse a string into a WidePayload256.</summary>
    public static bool TryParse(string? s, IFormatProvider? provider, out WidePayload256 result)
    {
    ...
    /// <summary>Parses a span of characters into a WidePayload256.</summary>
    public static WidePayload256 Parse(ReadOnlySpan<char> s, IFormatProvider? provider) => Parse(s.ToString(), provider);

    /// <summary>Tries to parse a span of characters into a WidePayload256.</summary>
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out WidePayload256 result) => TryParse(s.ToString(), provider, out result);

    /// <summary>Parses a string using invariant culture.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WidePayload256 Parse(string s) => Parse(s, CultureInfo.InvariantCulture);
    ...
    public int CompareTo(object? obj)
    {
        ...
        throw new ArgumentException("Object must be of type WidePayload256", nameof(obj));
    }
    ...
    {
        /// <summary>Reads a WidePayload256 from a JSON string.</summary>
        public override WidePayload256 Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var s = reader.GetString();
            return s is null ? default : WidePayload256.Parse(s);
        }

        /// <summary>Writes a WidePayload256 to JSON as a hex string.</summary>
        public override void Write(Utf8JsonWriter writer, WidePayload256 value, JsonSerializerOptions options)
        {
