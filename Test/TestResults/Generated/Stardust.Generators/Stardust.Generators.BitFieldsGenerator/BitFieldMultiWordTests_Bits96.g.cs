...
public partial class BitFieldMultiWordTests
{
    ...
    [JsonConverter(typeof(Bits96JsonConverter))]
    public partial struct Bits96 : IComparable, IComparable<Bits96>, IEquatable<Bits96>,
                                 IFormattable, ISpanFormattable, IParsable<Bits96>, ISpanParsable<Bits96>
    {
        private ulong __w0; // bits 0-63
        private uint __w1; // bits 64-95
        ...
        private const int __TOTAL_BITS = 96;

        /// <summary>Size of this struct in bytes.</summary>
        public const int SIZE_IN_BYTES = 12;
        /// <summary>Total number of bits in this struct.</summary>
        public const int BIT_WIDTH = 96;

        private const ulong __LAST_WORD_MASK = 0x00000000FFFFFFFFUL;

        /// <summary>Returns a Bits96 with all bits set to zero.</summary>
        public static Bits96 Zero => default;

        /// <summary>Creates a new Bits96 from individual word values.</summary>
        /// <param name="lower">Bits 0-63 (least significant).</param>
        /// <param name="upper">Bits 64-95 (most significant).</param>
        public Bits96(ulong lower, uint upper)
        {
            __w0 = lower;
            __w1 = upper;
        }

        /// <summary>Creates a new Bits96 from a ulong value (zero-extended).</summary>
        public Bits96(ulong value) : this(value, default(uint)) { }

        /// <summary>Creates a new Bits96 from an int value. Negative values are sign-extended
        /// to all 96 bits (e.g., -1 sets all bits to 1).</summary>
        public Bits96(int value)
        {
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => (uint)(((ulong)__w1) & 0xFFFFFFFFUL);
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => __w1 = (uint)((((ulong)__w1) & 0xFFFFFFFF00000000UL) | ((ulong)value & 0x00000000FFFFFFFFUL));
        }

        /// <summary>Returns a Bits96 with the mask for the Low field (bits 0-63).</summary>
        public static Bits96 LowMask => new(0xFFFFFFFFFFFFFFFFUL, default(uint));

        /// <summary>Returns a Bits96 with the mask for the High field (bits 64-95).</summary>
        public static Bits96 HighMask => new(0UL, 0xFFFFFFFFU);

        /// <summary>Returns a new Bits96 with the Low field set to the specified value.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Bits96 WithLow(ulong value) { var copy = this; copy.Low = value; return copy; }

        /// <summary>Returns a new Bits96 with the High field set to the specified value.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        {
            new("Low", 0, 64, "ulong", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 96, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
            new("High", 64, 32, "uint", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 96, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        };

        /// <summary>Bitwise complement operator.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Bits96 operator ~(Bits96 a) => new(~a.__w0, (uint)(~((ulong)a.__w1)));

        /// <summary>Bitwise OR operator.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Bits96 operator |(Bits96 a, Bits96 b) => new(a.__w0 | b.__w0, (uint)(((ulong)a.__w1) | ((ulong)b.__w1)));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Bits96 operator &(Bits96 a, ulong b) => new(a.__w0 & b, default(uint));

        /// <summary>Unary plus operator.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Bits96 operator +(Bits96 a) => a;

        /// <summary>Unary negation operator. Returns two's complement negation.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Bits96 operator -(Bits96 a) => ~a + new Bits96(1UL);

        /// <summary>Addition operator with carry propagation.</summary>
        public static Bits96 operator +(Bits96 a, Bits96 b)
        {
            ulong w0 = a.__w0 + b.__w0;
            ulong c0 = (w0 < a.__w0) ? 1UL : 0UL;
            ulong w1 = ((ulong)a.__w1) + ((ulong)b.__w1) + c0;
            return new(w0, (uint)w1);
        }

        /// <summary>Addition operator with ulong.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Bits96 operator +(Bits96 a, ulong b) => a + new Bits96(b);
        ...
        public static Bits96 operator *(Bits96 a, Bits96 b) => FromBigInteger(a.ToBigInteger() * b.ToBigInteger());

        /// <summary>Multiplication operator with ulong.</summary>
        public static Bits96 operator *(Bits96 a, ulong b) => FromBigInteger(a.ToBigInteger() * b);

        /// <summary>Multiplication operator with ulong.</summary>
        public static Bits96 operator *(ulong a, Bits96 b) => FromBigInteger(a * b.ToBigInteger());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Bits96 operator >>>(Bits96 a, int amount) => a >> amount;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static ulong GetWord(Bits96 v, int index)
        {
            return index switch
            {
                0 => v.__w0,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void SetWord(ref Bits96 v, int index, ulong value)
        {
            switch (index)
            {
                case 0: v.__w0 = value; break;
                case 1: v.__w1 = (uint)(value); break;
            }
        }

        /// <summary>Less than operator.</summary>
        public static bool operator <(Bits96 a, Bits96 b)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator >(Bits96 a, Bits96 b) => b < a;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(Bits96 a, Bits96 b) => a.__w0 == b.__w0 && a.__w1 == b.__w1;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Bits96(ulong value) => new(value);

        /// <summary>Implicit conversion from int.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Bits96(int value) => new(value);

        /// <summary>Explicit conversion to BigInteger.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator BigInteger(Bits96 value) => value.ToBigInteger();
        ...
        /// <summary>Creates a Bits96 from a BigInteger (truncated to 96 bits).</summary>
        public static Bits96 FromBigInteger(BigInteger value)
        {
        ...
        /// <summary>Creates a new Bits96 from a little-endian byte span.</summary>
        /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
        /// <exception cref="ArgumentException">The span is too short.</exception>
        public Bits96(ReadOnlySpan<byte> bytes)
        {
            ...
            __w1 = BinaryPrimitives.ReadUInt32LittleEndian(bytes.Slice(8));
        }

        /// <summary>Creates a new Bits96 by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
        /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
        /// <returns>The deserialized Bits96.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Bits96 ReadFrom(ReadOnlySpan<byte> bytes) => new(bytes);
        ...
        public void WriteTo(Span<byte> destination)
        {
            ...
            BinaryPrimitives.WriteUInt32LittleEndian(destination.Slice(8), __w1);
        }
        ...
        /// <summary>Parses a string into a Bits96. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        public static Bits96 Parse(string s, IFormatProvider? provider)
        {
        ...
        /// <summary>Tries to parse a string into a Bits96.</summary>
        public static bool TryParse(string? s, IFormatProvider? provider, out Bits96 result)
        {
        ...
        /// <summary>Parses a span of characters into a Bits96.</summary>
        public static Bits96 Parse(ReadOnlySpan<char> s, IFormatProvider? provider) => Parse(s.ToString(), provider);

        /// <summary>Tries to parse a span of characters into a Bits96.</summary>
        public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out Bits96 result) => TryParse(s.ToString(), provider, out result);

        /// <summary>Parses a string using invariant culture.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Bits96 Parse(string s) => Parse(s, CultureInfo.InvariantCulture);
        ...
        public int CompareTo(object? obj)
        {
            ...
            throw new ArgumentException("Object must be of type Bits96", nameof(obj));
        }
        ...
        {
            /// <summary>Reads a Bits96 from a JSON string.</summary>
            public override Bits96 Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                return s is null ? default : Bits96.Parse(s);
            }

            /// <summary>Writes a Bits96 to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, Bits96 value, JsonSerializerOptions options)
            {
