...
{
    [JsonConverter(typeof(FuzzTestReg8JsonConverter))]
                                 ...
                                 IFormattable, ISpanFormattable, IParsable<FuzzTestReg8>, ISpanParsable<FuzzTestReg8>
    {
        ...
        public static FuzzTestReg8 Flag0Bit { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(__FLAG0_MASK); }

        /// <summary>Returns a FuzzTestReg8 with the mask for the Field1 field (bits 1-4).</summary>
        public static FuzzTestReg8 Field1Mask { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(__FIELD1_SHIFTED_MASK); }
        ...
        {
            new("Field1", 1, 4, "byte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 8, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FuzzTestReg8 operator +(FuzzTestReg8 a) => a;
        ...
        /// <summary>Parses a string into a FuzzTestReg8. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <returns>The parsed FuzzTestReg8 value.</returns>
        /// <exception cref="ArgumentNullException">s is null.</exception>
        public static FuzzTestReg8 Parse(string s, IFormatProvider? provider)
        {
        ...
        /// <summary>Tries to parse a string into a FuzzTestReg8. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        public static bool TryParse(string? s, IFormatProvider? provider, out FuzzTestReg8 result)
        {
        ...
        /// <summary>Parses a span of characters into a FuzzTestReg8. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The span of characters to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <returns>The parsed FuzzTestReg8 value.</returns>
        public static FuzzTestReg8 Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
        {
            if (IsBinaryPrefix(s))
        ...
        /// <summary>Tries to parse a span of characters into a FuzzTestReg8. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The span of characters to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out FuzzTestReg8 result)
        {
            if (IsBinaryPrefix(s))
            {
        ...
        /// <summary>Parses a string into a FuzzTestReg8 using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <returns>The parsed FuzzTestReg8 value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FuzzTestReg8 Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

        /// <summary>Tries to parse a string into a FuzzTestReg8 using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool TryParse(string? s, out FuzzTestReg8 result) => TryParse(s, CultureInfo.InvariantCulture, out result);
        ...
        public int CompareTo(object? obj)
        {
            ...
            throw new ArgumentException("Object must be of type FuzzTestReg8", nameof(obj));
        }

        /// <summary>Compares this instance to another FuzzTestReg8 and returns an integer indicating their relative order.</summary>
        ...
        {
            /// <summary>Reads a FuzzTestReg8 from a JSON string.</summary>
            public override FuzzTestReg8 Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                return s is null ? default : FuzzTestReg8.Parse(s);
            }

            /// <summary>Writes a FuzzTestReg8 to JSON as a string.</summary>
            public override void Write(Utf8JsonWriter writer, FuzzTestReg8 value, JsonSerializerOptions options)
            {
