...
public partial class ExtensionsTests
{
                                 ...
                                 IFormattable, ISpanFormattable, IParsable<IPv4Flags>, ISpanParsable<IPv4Flags>
    {
        ...
        {
            new("MoreFragments", 0, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 8, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Zeroes),
            new("DontFragment", 1, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 8, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Zeroes),
            new("Reserved", 2, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 8, FieldMustBe: MustBe.Zero, StructUndefinedMustBe: UndefinedBitsMustBe.Zeroes),
        };
        ...
        public override readonly bool Equals(object? obj) => obj is IPv4Flags other && __GetNormalizedValue() == other.__GetNormalizedValue();
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly int CompareTo(IPv4Flags other) => __GetNormalizedValue().CompareTo(other.__GetNormalizedValue());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(IPv4Flags other) => __GetNormalizedValue() == other.__GetNormalizedValue();
