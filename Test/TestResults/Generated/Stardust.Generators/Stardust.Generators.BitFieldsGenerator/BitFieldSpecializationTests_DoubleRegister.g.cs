...
public partial class BitFieldSpecializationTests
{
                                 ...
                                 IFormattable, ISpanFormattable, IParsable<DoubleRegister>, ISpanParsable<DoubleRegister>
    {
        ...
        public override readonly bool Equals(object? obj) => obj is DoubleRegister other && __value == other.__value;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly int CompareTo(DoubleRegister other) => BitConverter.UInt64BitsToDouble(__value).CompareTo(BitConverter.UInt64BitsToDouble(other.__value));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(DoubleRegister other) => __value == other.__value;
