...
[JsonConverter(typeof(SatSignedSbyteJsonConverter))]
                             ...
                             IFormattable, ISpanFormattable, IParsable<SatSignedSbyte>, ISpanParsable<SatSignedSbyte>
{
    ...
    {
        new("Val", 0, 3, "sbyte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 8, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
    };

    /// <summary>Returns a new SatSignedSbyte with the Val field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SatSignedSbyte operator +(SatSignedSbyte a) => a;
    ...
    public override readonly bool Equals(object? obj) => obj is SatSignedSbyte other && __value == other.__value;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator SatSignedSbyte(int value) => new(unchecked((sbyte)value));

    /// <summary>Creates a new SatSignedSbyte from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    /// <exception cref="ArgumentException">The span is too short.</exception>
    public SatSignedSbyte(ReadOnlySpan<byte> bytes)
    {
        if (bytes.Length < SIZE_IN_BYTES)
            throw new ArgumentException($"Span must contain at least {SIZE_IN_BYTES} bytes.", nameof(bytes));
        this = new SatSignedSbyte(unchecked((sbyte)bytes[0]));
    }

    /// <summary>Creates a new SatSignedSbyte by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    /// <returns>The deserialized SatSignedSbyte.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SatSignedSbyte ReadFrom(ReadOnlySpan<byte> bytes) => new(bytes);
    ...
    /// <summary>Parses a string into a SatSignedSbyte. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <returns>The parsed SatSignedSbyte value.</returns>
    /// <exception cref="ArgumentNullException">s is null.</exception>
    public static SatSignedSbyte Parse(string s, IFormatProvider? provider)
    {
    ...
    /// <summary>Tries to parse a string into a SatSignedSbyte. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    public static bool TryParse(string? s, IFormatProvider? provider, out SatSignedSbyte result)
    {
    ...
    /// <summary>Parses a span of characters into a SatSignedSbyte. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The span of characters to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <returns>The parsed SatSignedSbyte value.</returns>
    public static SatSignedSbyte Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
    {
        if (IsBinaryPrefix(s))
    ...
    /// <summary>Tries to parse a span of characters into a SatSignedSbyte. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The span of characters to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out SatSignedSbyte result)
    {
        if (IsBinaryPrefix(s))
        {
    ...
    /// <summary>Parses a string into a SatSignedSbyte using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <returns>The parsed SatSignedSbyte value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SatSignedSbyte Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

    /// <summary>Tries to parse a string into a SatSignedSbyte using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool TryParse(string? s, out SatSignedSbyte result) => TryParse(s, CultureInfo.InvariantCulture, out result);
    ...
    /// <exception cref="ArgumentException">obj is not a SatSignedSbyte.</exception>
    public readonly int CompareTo(object? obj)
    {
        if (obj is null) return 1;
        if (obj is SatSignedSbyte other) return CompareTo(other);
        throw new ArgumentException("Object must be of type SatSignedSbyte", nameof(obj));
    }

    /// <summary>Compares this instance to another SatSignedSbyte and returns an integer indicating their relative order.</summary>
    /// <param name="other">A SatSignedSbyte to compare.</param>
    /// <returns>A value indicating the relative order of the instances being compared.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(SatSignedSbyte other) => __value.CompareTo(other.__value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(SatSignedSbyte other) => __value == other.__value;
    ...
    {
        /// <summary>Reads a SatSignedSbyte from a JSON string.</summary>
        public override SatSignedSbyte Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var s = reader.GetString();
            return s is null ? default : SatSignedSbyte.Parse(s);
        }

        /// <summary>Writes a SatSignedSbyte to JSON as a string.</summary>
        public override void Write(Utf8JsonWriter writer, SatSignedSbyte value, JsonSerializerOptions options)
        {
