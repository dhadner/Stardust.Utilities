...
{
    [JsonConverter(typeof(Reg_MsbJsonConverter))]
                                 ...
                                 IFormattable, ISpanFormattable, IParsable<Reg_Msb>, ISpanParsable<Reg_Msb>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Reg_Msb operator +(Reg_Msb a) => a;
        ...
        public override readonly bool Equals(object? obj) => obj is Reg_Msb other && __value == other.__value;
        ...
        /// <summary>Parses a string into a Reg_Msb. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <returns>The parsed Reg_Msb value.</returns>
        /// <exception cref="ArgumentNullException">s is null.</exception>
        public static Reg_Msb Parse(string s, IFormatProvider? provider)
        {
        ...
        /// <summary>Tries to parse a string into a Reg_Msb. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        public static bool TryParse(string? s, IFormatProvider? provider, out Reg_Msb result)
        {
        ...
        /// <summary>Parses a span of characters into a Reg_Msb. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The span of characters to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <returns>The parsed Reg_Msb value.</returns>
        public static Reg_Msb Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
        {
            if (IsBinaryPrefix(s))
        ...
        /// <summary>Tries to parse a span of characters into a Reg_Msb. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The span of characters to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out Reg_Msb result)
        {
            if (IsBinaryPrefix(s))
            {
        ...
        /// <summary>Parses a string into a Reg_Msb using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <returns>The parsed Reg_Msb value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Reg_Msb Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

        /// <summary>Tries to parse a string into a Reg_Msb using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool TryParse(string? s, out Reg_Msb result) => TryParse(s, CultureInfo.InvariantCulture, out result);
        ...
        /// <exception cref="ArgumentException">obj is not a Reg_Msb.</exception>
        public readonly int CompareTo(object? obj)
        {
            if (obj is null) return 1;
            if (obj is Reg_Msb other) return CompareTo(other);
            throw new ArgumentException("Object must be of type Reg_Msb", nameof(obj));
        }

        /// <summary>Compares this instance to another Reg_Msb and returns an integer indicating their relative order.</summary>
        /// <param name="other">A Reg_Msb to compare.</param>
        /// <returns>A value indicating the relative order of the instances being compared.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly int CompareTo(Reg_Msb other) => __value.CompareTo(other.__value);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(Reg_Msb other) => __value == other.__value;
        ...
        {
            /// <summary>Reads a Reg_Msb from a JSON string.</summary>
            public override Reg_Msb Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                return s is null ? default : Reg_Msb.Parse(s);
            }

            /// <summary>Writes a Reg_Msb to JSON as a string.</summary>
            public override void Write(Utf8JsonWriter writer, Reg_Msb value, JsonSerializerOptions options)
            {
