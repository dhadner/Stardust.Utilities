...
public partial class BitFieldMultiWordTests
{
                                 ...
                                 IFormattable, ISpanFormattable, IParsable<Bits200>, ISpanParsable<Bits200>
    {
        ...
        public const int BIT_WIDTH = 200;
        ...
        {
            new("Word0", 0, 64, "ulong", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 200, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
            new("Word1", 64, 64, "ulong", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 200, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
            new("Word2", 128, 64, "ulong", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 200, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
            new("Tag", 193, 7, "byte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 200, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
            new("Valid", 192, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 200, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        };
        ...
        public override readonly bool Equals(object? obj) => obj is Bits200 other && this == other;
        ...
        public readonly int CompareTo(Bits200 other)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(Bits200 other) => this == other;
