...
{
    [JsonConverter(typeof(IPv4TtlWordJsonConverter))]
                                 ...
                                 IFormattable, ISpanFormattable, IParsable<IPv4TtlWord>, ISpanParsable<IPv4TtlWord>
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IPv4TtlWord operator +(IPv4TtlWord a) => a;
        ...
        public override readonly bool Equals(object? obj) => obj is IPv4TtlWord other && __value == other.__value;
        ...
        /// <summary>Parses a string into a IPv4TtlWord. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <returns>The parsed IPv4TtlWord value.</returns>
        /// <exception cref="ArgumentNullException">s is null.</exception>
        public static IPv4TtlWord Parse(string s, IFormatProvider? provider)
        {
        ...
        /// <summary>Tries to parse a string into a IPv4TtlWord. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        public static bool TryParse(string? s, IFormatProvider? provider, out IPv4TtlWord result)
        {
        ...
        /// <summary>Parses a span of characters into a IPv4TtlWord. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The span of characters to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <returns>The parsed IPv4TtlWord value.</returns>
        public static IPv4TtlWord Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
        {
            if (IsBinaryPrefix(s))
        ...
        /// <summary>Tries to parse a span of characters into a IPv4TtlWord. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The span of characters to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out IPv4TtlWord result)
        {
            if (IsBinaryPrefix(s))
            {
        ...
        /// <summary>Parses a string into a IPv4TtlWord using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <returns>The parsed IPv4TtlWord value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static IPv4TtlWord Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

        /// <summary>Tries to parse a string into a IPv4TtlWord using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool TryParse(string? s, out IPv4TtlWord result) => TryParse(s, CultureInfo.InvariantCulture, out result);
        ...
        /// <exception cref="ArgumentException">obj is not a IPv4TtlWord.</exception>
        public readonly int CompareTo(object? obj)
        {
            if (obj is null) return 1;
            if (obj is IPv4TtlWord other) return CompareTo(other);
            throw new ArgumentException("Object must be of type IPv4TtlWord", nameof(obj));
        }

        /// <summary>Compares this instance to another IPv4TtlWord and returns an integer indicating their relative order.</summary>
        /// <param name="other">A IPv4TtlWord to compare.</param>
        /// <returns>A value indicating the relative order of the instances being compared.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly int CompareTo(IPv4TtlWord other) => __value.CompareTo(other.__value);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(IPv4TtlWord other) => __value == other.__value;
        ...
        {
            /// <summary>Reads a IPv4TtlWord from a JSON string.</summary>
            public override IPv4TtlWord Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                return s is null ? default : IPv4TtlWord.Parse(s);
            }

            /// <summary>Writes a IPv4TtlWord to JSON as a string.</summary>
            public override void Write(Utf8JsonWriter writer, IPv4TtlWord value, JsonSerializerOptions options)
            {
