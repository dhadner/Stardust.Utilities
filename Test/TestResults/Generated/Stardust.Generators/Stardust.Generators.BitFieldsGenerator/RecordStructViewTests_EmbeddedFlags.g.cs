...
{
    [JsonConverter(typeof(EmbeddedFlagsJsonConverter))]
                                 ...
                                 IFormattable, ISpanFormattable, IParsable<EmbeddedFlags>, ISpanParsable<EmbeddedFlags>
    {
        ...
        {
            new("Code", 4, 4, "byte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 8, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
            ...
            new("Valid", 1, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 8, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        };
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EmbeddedFlags operator +(EmbeddedFlags a) => a;
        ...
        public override readonly bool Equals(object? obj) => obj is EmbeddedFlags other && __value == other.__value;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator EmbeddedFlags(int value) => new(unchecked((byte)value));

        /// <summary>Creates a new EmbeddedFlags from a little-endian byte span.</summary>
        /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
        /// <exception cref="ArgumentException">The span is too short.</exception>
        public EmbeddedFlags(ReadOnlySpan<byte> bytes)
        {
        ...
        /// <summary>Creates a new EmbeddedFlags by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
        /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
        /// <returns>The deserialized EmbeddedFlags.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EmbeddedFlags ReadFrom(ReadOnlySpan<byte> bytes) => new(bytes);
        ...
        /// <summary>Parses a string into a EmbeddedFlags. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <returns>The parsed EmbeddedFlags value.</returns>
        /// <exception cref="ArgumentNullException">s is null.</exception>
        public static EmbeddedFlags Parse(string s, IFormatProvider? provider)
        {
        ...
        /// <summary>Tries to parse a string into a EmbeddedFlags. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        public static bool TryParse(string? s, IFormatProvider? provider, out EmbeddedFlags result)
        {
        ...
        /// <summary>Parses a span of characters into a EmbeddedFlags. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The span of characters to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <returns>The parsed EmbeddedFlags value.</returns>
        public static EmbeddedFlags Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
        {
            if (IsBinaryPrefix(s))
        ...
        /// <summary>Tries to parse a span of characters into a EmbeddedFlags. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The span of characters to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out EmbeddedFlags result)
        {
            if (IsBinaryPrefix(s))
            {
        ...
        /// <summary>Parses a string into a EmbeddedFlags using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <returns>The parsed EmbeddedFlags value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static EmbeddedFlags Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

        /// <summary>Tries to parse a string into a EmbeddedFlags using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool TryParse(string? s, out EmbeddedFlags result) => TryParse(s, CultureInfo.InvariantCulture, out result);
        ...
        /// <exception cref="ArgumentException">obj is not a EmbeddedFlags.</exception>
        public readonly int CompareTo(object? obj)
        {
            if (obj is null) return 1;
            if (obj is EmbeddedFlags other) return CompareTo(other);
            throw new ArgumentException("Object must be of type EmbeddedFlags", nameof(obj));
        }

        /// <summary>Compares this instance to another EmbeddedFlags and returns an integer indicating their relative order.</summary>
        /// <param name="other">A EmbeddedFlags to compare.</param>
        /// <returns>A value indicating the relative order of the instances being compared.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly int CompareTo(EmbeddedFlags other) => __value.CompareTo(other.__value);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(EmbeddedFlags other) => __value == other.__value;
        ...
        {
            /// <summary>Reads a EmbeddedFlags from a JSON string.</summary>
            public override EmbeddedFlags Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                return s is null ? default : EmbeddedFlags.Parse(s);
            }

            /// <summary>Writes a EmbeddedFlags to JSON as a string.</summary>
            public override void Write(Utf8JsonWriter writer, EmbeddedFlags value, JsonSerializerOptions options)
            {
