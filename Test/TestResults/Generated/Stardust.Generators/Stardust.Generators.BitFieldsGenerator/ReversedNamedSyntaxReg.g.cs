...
[JsonConverter(typeof(ReversedNamedSyntaxRegJsonConverter))]
                             ...
                             IFormattable, ISpanFormattable, IParsable<ReversedNamedSyntaxReg>, ISpanParsable<ReversedNamedSyntaxReg>
{
    ...
    public static ReversedNamedSyntaxReg UpperFiveMask { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(__UPPER_FIVE_SHIFTED_MASK); }

    /// <summary>Returns a ReversedNamedSyntaxReg with the mask for the LowerThree field (bits 0-2).</summary>
    public static ReversedNamedSyntaxReg LowerThreeMask { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(__LOWER_THREE_MASK); }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ReversedNamedSyntaxReg operator +(ReversedNamedSyntaxReg a) => a;
    ...
    public override readonly bool Equals(object? obj) => obj is ReversedNamedSyntaxReg other && __value == other.__value;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator ReversedNamedSyntaxReg(int value) => new(unchecked((byte)value));

    /// <summary>Creates a new ReversedNamedSyntaxReg from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    /// <exception cref="ArgumentException">The span is too short.</exception>
    public ReversedNamedSyntaxReg(ReadOnlySpan<byte> bytes)
    {
        if (bytes.Length < SIZE_IN_BYTES)
            throw new ArgumentException($"Span must contain at least {SIZE_IN_BYTES} bytes.", nameof(bytes));
        this = new ReversedNamedSyntaxReg(bytes[0]);
    }

    /// <summary>Creates a new ReversedNamedSyntaxReg by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    /// <returns>The deserialized ReversedNamedSyntaxReg.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ReversedNamedSyntaxReg ReadFrom(ReadOnlySpan<byte> bytes) => new(bytes);
    ...
    /// <summary>Parses a string into a ReversedNamedSyntaxReg. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <returns>The parsed ReversedNamedSyntaxReg value.</returns>
    /// <exception cref="ArgumentNullException">s is null.</exception>
    public static ReversedNamedSyntaxReg Parse(string s, IFormatProvider? provider)
    {
    ...
    /// <summary>Tries to parse a string into a ReversedNamedSyntaxReg. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    public static bool TryParse(string? s, IFormatProvider? provider, out ReversedNamedSyntaxReg result)
    {
    ...
    /// <summary>Parses a span of characters into a ReversedNamedSyntaxReg. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The span of characters to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <returns>The parsed ReversedNamedSyntaxReg value.</returns>
    public static ReversedNamedSyntaxReg Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
    {
        if (IsBinaryPrefix(s))
    ...
    /// <summary>Tries to parse a span of characters into a ReversedNamedSyntaxReg. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The span of characters to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out ReversedNamedSyntaxReg result)
    {
        if (IsBinaryPrefix(s))
        {
    ...
    /// <summary>Parses a string into a ReversedNamedSyntaxReg using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <returns>The parsed ReversedNamedSyntaxReg value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ReversedNamedSyntaxReg Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

    /// <summary>Tries to parse a string into a ReversedNamedSyntaxReg using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool TryParse(string? s, out ReversedNamedSyntaxReg result) => TryParse(s, CultureInfo.InvariantCulture, out result);
    ...
    /// <exception cref="ArgumentException">obj is not a ReversedNamedSyntaxReg.</exception>
    public readonly int CompareTo(object? obj)
    {
        if (obj is null) return 1;
        if (obj is ReversedNamedSyntaxReg other) return CompareTo(other);
        throw new ArgumentException("Object must be of type ReversedNamedSyntaxReg", nameof(obj));
    }

    /// <summary>Compares this instance to another ReversedNamedSyntaxReg and returns an integer indicating their relative order.</summary>
    /// <param name="other">A ReversedNamedSyntaxReg to compare.</param>
    /// <returns>A value indicating the relative order of the instances being compared.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(ReversedNamedSyntaxReg other) => __value.CompareTo(other.__value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(ReversedNamedSyntaxReg other) => __value == other.__value;
    ...
    {
        /// <summary>Reads a ReversedNamedSyntaxReg from a JSON string.</summary>
        public override ReversedNamedSyntaxReg Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var s = reader.GetString();
            return s is null ? default : ReversedNamedSyntaxReg.Parse(s);
        }

        /// <summary>Writes a ReversedNamedSyntaxReg to JSON as a string.</summary>
        public override void Write(Utf8JsonWriter writer, ReversedNamedSyntaxReg value, JsonSerializerOptions options)
        {
