...
{
    [JsonConverter(typeof(FullDouble64JsonConverter))]
                                 ...
                                 IFormattable, ISpanFormattable, IParsable<FullDouble64>, ISpanParsable<FullDouble64>
    {
        ...
        {
            new("DoubleVal", 0, 64, "double", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 64, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        };
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FullDouble64 operator +(FullDouble64 a) => a;
        ...
        public override readonly bool Equals(object? obj) => obj is FullDouble64 other && __value == other.__value;
        ...
        /// <summary>Creates a new FullDouble64 from a little-endian byte span.</summary>
        /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
        /// <exception cref="ArgumentException">The span is too short.</exception>
        public FullDouble64(ReadOnlySpan<byte> bytes)
        {
            if (bytes.Length < SIZE_IN_BYTES)
                throw new ArgumentException($"Span must contain at least {SIZE_IN_BYTES} bytes.", nameof(bytes));
            this = new FullDouble64(BinaryPrimitives.ReadUInt64LittleEndian(bytes));
        }

        /// <summary>Creates a new FullDouble64 by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
        /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
        /// <returns>The deserialized FullDouble64.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FullDouble64 ReadFrom(ReadOnlySpan<byte> bytes) => new(bytes);
        ...
        /// <summary>Parses a string into a FullDouble64. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <returns>The parsed FullDouble64 value.</returns>
        /// <exception cref="ArgumentNullException">s is null.</exception>
        public static FullDouble64 Parse(string s, IFormatProvider? provider)
        {
        ...
        /// <summary>Tries to parse a string into a FullDouble64. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        public static bool TryParse(string? s, IFormatProvider? provider, out FullDouble64 result)
        {
        ...
        /// <summary>Parses a span of characters into a FullDouble64. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The span of characters to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <returns>The parsed FullDouble64 value.</returns>
        public static FullDouble64 Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
        {
            if (IsBinaryPrefix(s))
        ...
        /// <summary>Tries to parse a span of characters into a FullDouble64. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The span of characters to parse.</param>
        /// <param name="provider">An object that provides culture-specific formatting information.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out FullDouble64 result)
        {
            if (IsBinaryPrefix(s))
            {
        ...
        /// <summary>Parses a string into a FullDouble64 using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <returns>The parsed FullDouble64 value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static FullDouble64 Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

        /// <summary>Tries to parse a string into a FullDouble64 using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        /// <param name="s">The string to parse.</param>
        /// <param name="result">When this method returns, contains the parsed value if successful.</param>
        /// <returns>true if parsing succeeded; otherwise, false.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool TryParse(string? s, out FullDouble64 result) => TryParse(s, CultureInfo.InvariantCulture, out result);
        ...
        /// <exception cref="ArgumentException">obj is not a FullDouble64.</exception>
        public readonly int CompareTo(object? obj)
        {
            if (obj is null) return 1;
            if (obj is FullDouble64 other) return CompareTo(other);
            throw new ArgumentException("Object must be of type FullDouble64", nameof(obj));
        }

        /// <summary>Compares this instance to another FullDouble64 and returns an integer indicating their relative order.</summary>
        /// <param name="other">A FullDouble64 to compare.</param>
        /// <returns>A value indicating the relative order of the instances being compared.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly int CompareTo(FullDouble64 other) => __value.CompareTo(other.__value);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(FullDouble64 other) => __value == other.__value;
        ...
        {
            /// <summary>Reads a FullDouble64 from a JSON string.</summary>
            public override FullDouble64 Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                return s is null ? default : FullDouble64.Parse(s);
            }

            /// <summary>Writes a FullDouble64 to JSON as a string.</summary>
            public override void Write(Utf8JsonWriter writer, FullDouble64 value, JsonSerializerOptions options)
            {
