...
[JsonConverter(typeof(SatShiftedFieldJsonConverter))]
                             ...
                             IFormattable, ISpanFormattable, IParsable<SatShiftedField>, ISpanParsable<SatShiftedField>
{
    ...
    {
        new("Prefix", 0, 4, "byte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 32, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        new("Clamped", 4, 5, "byte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 32, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
    };
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SatShiftedField operator +(SatShiftedField a) => a;
    ...
    public override readonly bool Equals(object? obj) => obj is SatShiftedField other && __value == other.__value;
    ...
    /// <summary>Creates a new SatShiftedField from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    /// <exception cref="ArgumentException">The span is too short.</exception>
    public SatShiftedField(ReadOnlySpan<byte> bytes)
    {
        if (bytes.Length < SIZE_IN_BYTES)
            throw new ArgumentException($"Span must contain at least {SIZE_IN_BYTES} bytes.", nameof(bytes));
        this = new SatShiftedField(BinaryPrimitives.ReadUInt32LittleEndian(bytes));
    }

    /// <summary>Creates a new SatShiftedField by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    /// <returns>The deserialized SatShiftedField.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SatShiftedField ReadFrom(ReadOnlySpan<byte> bytes) => new(bytes);
    ...
    /// <summary>Parses a string into a SatShiftedField. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <returns>The parsed SatShiftedField value.</returns>
    /// <exception cref="ArgumentNullException">s is null.</exception>
    public static SatShiftedField Parse(string s, IFormatProvider? provider)
    {
    ...
    /// <summary>Tries to parse a string into a SatShiftedField. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    public static bool TryParse(string? s, IFormatProvider? provider, out SatShiftedField result)
    {
    ...
    /// <summary>Parses a span of characters into a SatShiftedField. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The span of characters to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <returns>The parsed SatShiftedField value.</returns>
    public static SatShiftedField Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
    {
        if (IsBinaryPrefix(s))
    ...
    /// <summary>Tries to parse a span of characters into a SatShiftedField. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The span of characters to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out SatShiftedField result)
    {
        if (IsBinaryPrefix(s))
        {
    ...
    /// <summary>Parses a string into a SatShiftedField using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <returns>The parsed SatShiftedField value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static SatShiftedField Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

    /// <summary>Tries to parse a string into a SatShiftedField using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool TryParse(string? s, out SatShiftedField result) => TryParse(s, CultureInfo.InvariantCulture, out result);
    ...
    /// <exception cref="ArgumentException">obj is not a SatShiftedField.</exception>
    public readonly int CompareTo(object? obj)
    {
        if (obj is null) return 1;
        if (obj is SatShiftedField other) return CompareTo(other);
        throw new ArgumentException("Object must be of type SatShiftedField", nameof(obj));
    }

    /// <summary>Compares this instance to another SatShiftedField and returns an integer indicating their relative order.</summary>
    /// <param name="other">A SatShiftedField to compare.</param>
    /// <returns>A value indicating the relative order of the instances being compared.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(SatShiftedField other) => __value.CompareTo(other.__value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(SatShiftedField other) => __value == other.__value;
    ...
    {
        /// <summary>Reads a SatShiftedField from a JSON string.</summary>
        public override SatShiftedField Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var s = reader.GetString();
            return s is null ? default : SatShiftedField.Parse(s);
        }

        /// <summary>Writes a SatShiftedField to JSON as a string.</summary>
        public override void Write(Utf8JsonWriter writer, SatShiftedField value, JsonSerializerOptions options)
        {
