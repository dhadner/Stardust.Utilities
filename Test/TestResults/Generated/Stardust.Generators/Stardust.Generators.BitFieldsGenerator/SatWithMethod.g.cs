                             ...
                             IFormattable, ISpanFormattable, IParsable<SatWithMethod>, ISpanParsable<SatWithMethod>
{
    ...
    public static SatWithMethod ClampedMask { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(unchecked((short)__CLAMPED_MASK)); }
    ...
    public override readonly bool Equals(object? obj) => obj is SatWithMethod other && __value == other.__value;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(SatWithMethod other) => __value.CompareTo(other.__value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(SatWithMethod other) => __value == other.__value;
