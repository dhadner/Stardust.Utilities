                             ...
                             IFormattable, ISpanFormattable, IParsable<SignedReg32>, ISpanParsable<SignedReg32>
{
    ...
    public static SignedReg32 Flag0Bit { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(unchecked((int)__FLAG0_MASK)); }

    /// <summary>Returns a SignedReg32 with only the Sign bit set.</summary>
    public static SignedReg32 SignBit { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(unchecked((int)__SIGN_MASK)); }

    /// <summary>Returns a SignedReg32 with the mask for the LowWord field (bits 1-15).</summary>
    public static SignedReg32 LowWordMask { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(unchecked((int)__LOW_WORD_SHIFTED_MASK)); }

    /// <summary>Returns a SignedReg32 with the mask for the HighWord field (bits 16-30).</summary>
    public static SignedReg32 HighWordMask { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(unchecked((int)__HIGH_WORD_SHIFTED_MASK)); }
    ...
    public override readonly bool Equals(object? obj) => obj is SignedReg32 other && __value == other.__value;
    ...
    public SignedReg32(ReadOnlySpan<byte> bytes)
    {
        ...
        this = new SignedReg32(BinaryPrimitives.ReadInt32LittleEndian(bytes));
    }

    /// <summary>Creates a new SignedReg32 by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(SignedReg32 other) => __value.CompareTo(other.__value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(SignedReg32 other) => __value == other.__value;
