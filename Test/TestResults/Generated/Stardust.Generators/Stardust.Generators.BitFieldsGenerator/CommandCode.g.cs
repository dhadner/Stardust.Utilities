...
[JsonConverter(typeof(CommandCodeJsonConverter))]
                             ...
                             IFormattable, ISpanFormattable, IParsable<CommandCode>, ISpanParsable<CommandCode>
{
    ...
    {
        new("Code", 0, 4, "byte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 8, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
    };
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CommandCode operator +(CommandCode a) => a;
    ...
    public override readonly bool Equals(object? obj) => obj is CommandCode other && __value == other.__value;
    ...
    /// <summary>Parses a string into a CommandCode. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <returns>The parsed CommandCode value.</returns>
    /// <exception cref="ArgumentNullException">s is null.</exception>
    public static CommandCode Parse(string s, IFormatProvider? provider)
    {
    ...
    /// <summary>Tries to parse a string into a CommandCode. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    public static bool TryParse(string? s, IFormatProvider? provider, out CommandCode result)
    {
    ...
    /// <summary>Parses a span of characters into a CommandCode. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The span of characters to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <returns>The parsed CommandCode value.</returns>
    public static CommandCode Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
    {
        if (IsBinaryPrefix(s))
    ...
    /// <summary>Tries to parse a span of characters into a CommandCode. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The span of characters to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out CommandCode result)
    {
        if (IsBinaryPrefix(s))
        {
    ...
    /// <summary>Parses a string into a CommandCode using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <returns>The parsed CommandCode value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static CommandCode Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

    /// <summary>Tries to parse a string into a CommandCode using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool TryParse(string? s, out CommandCode result) => TryParse(s, CultureInfo.InvariantCulture, out result);
    ...
    /// <exception cref="ArgumentException">obj is not a CommandCode.</exception>
    public readonly int CompareTo(object? obj)
    {
        if (obj is null) return 1;
        if (obj is CommandCode other) return CompareTo(other);
        throw new ArgumentException("Object must be of type CommandCode", nameof(obj));
    }

    /// <summary>Compares this instance to another CommandCode and returns an integer indicating their relative order.</summary>
    /// <param name="other">A CommandCode to compare.</param>
    /// <returns>A value indicating the relative order of the instances being compared.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(CommandCode other) => __value.CompareTo(other.__value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(CommandCode other) => __value == other.__value;
    ...
    {
        /// <summary>Reads a CommandCode from a JSON string.</summary>
        public override CommandCode Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var s = reader.GetString();
            return s is null ? default : CommandCode.Parse(s);
        }

        /// <summary>Writes a CommandCode to JSON as a string.</summary>
        public override void Write(Utf8JsonWriter writer, CommandCode value, JsonSerializerOptions options)
        {
