...
public partial class FloatingPointPropertyTests
{
    ...
    [JsonConverter(typeof(MixedFloatRegister128JsonConverter))]
                                 ...
                                 IFormattable, ISpanFormattable, IParsable<MixedFloatRegister128>, ISpanParsable<MixedFloatRegister128>
    {
        ...
        /// <summary>Creates a new MixedFloatRegister128 from individual word values.</summary>
        ...
        public MixedFloatRegister128(ulong value) : this(value, 0UL) { }

        /// <summary>Creates a new MixedFloatRegister128 from an int value. Negative values are sign-extended
        /// to all 128 bits (e.g., -1 sets all bits to 1).</summary>
        public MixedFloatRegister128(int value)
        {
        ...
        public static MixedFloatRegister128 PadFlagBit => new(0UL, 0x4000000000000000UL);

        /// <summary>Returns a MixedFloatRegister128 with only the SignFlag bit set.</summary>
        public static MixedFloatRegister128 SignFlagBit => new(0UL, 0x8000000000000000UL);

        /// <summary>Returns a MixedFloatRegister128 with the mask for the DoubleVal field (bits 0-63).</summary>
        public static MixedFloatRegister128 DoubleValMask => new(0xFFFFFFFFFFFFFFFFUL, 0UL);

        /// <summary>Returns a MixedFloatRegister128 with the mask for the FloatVal field (bits 64-95).</summary>
        public static MixedFloatRegister128 FloatValMask => new(0UL, 0xFFFFFFFFUL);

        /// <summary>Returns a MixedFloatRegister128 with the mask for the HalfVal field (bits 96-111).</summary>
        public static MixedFloatRegister128 HalfValMask => new(0UL, 0xFFFF00000000UL);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public MixedFloatRegister128 WithDoubleVal(double value) { var copy = this; copy.DoubleVal = value; return copy; }

        /// <summary>Returns a new MixedFloatRegister128 with the FloatVal field set to the specified value.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public MixedFloatRegister128 WithFloatVal(float value) { var copy = this; copy.FloatVal = value; return copy; }

        /// <summary>Returns a new MixedFloatRegister128 with the HalfVal field set to the specified value.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public MixedFloatRegister128 WithHalfVal(global::System.Half value) { var copy = this; copy.HalfVal = value; return copy; }
        ...
        {
            new("DoubleVal", 0, 64, "double", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 128, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
            new("FloatVal", 64, 32, "float", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 128, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
            new("HalfVal", 96, 16, "System.Half", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 128, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
            new("PadFlag", 126, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 128, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
            new("SignFlag", 127, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 128, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        };
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MixedFloatRegister128 operator +(MixedFloatRegister128 a) => a;

        /// <summary>Unary negation operator. Returns two's complement negation.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MixedFloatRegister128 operator -(MixedFloatRegister128 a) => ~a + new MixedFloatRegister128(1UL);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MixedFloatRegister128 operator +(MixedFloatRegister128 a, ulong b) => a + new MixedFloatRegister128(b);
        ...
        public static MixedFloatRegister128 operator *(MixedFloatRegister128 a, MixedFloatRegister128 b) => FromBigInteger(a.ToBigInteger() * b.ToBigInteger());

        /// <summary>Multiplication operator with ulong.</summary>
        public static MixedFloatRegister128 operator *(MixedFloatRegister128 a, ulong b) => FromBigInteger(a.ToBigInteger() * b);

        /// <summary>Multiplication operator with ulong.</summary>
        public static MixedFloatRegister128 operator *(ulong a, MixedFloatRegister128 b) => FromBigInteger(a * b.ToBigInteger());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MixedFloatRegister128 operator >>>(MixedFloatRegister128 a, int amount) => a >> amount;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static ulong GetWord(MixedFloatRegister128 v, int index)
        {
            return index switch
            {
                0 => v.__w0,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void SetWord(ref MixedFloatRegister128 v, int index, ulong value)
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator >(MixedFloatRegister128 a, MixedFloatRegister128 b) => b < a;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator >=(MixedFloatRegister128 a, MixedFloatRegister128 b) => !(a < b);
        ...
        public override readonly bool Equals(object? obj) => obj is MixedFloatRegister128 other && this == other;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MixedFloatRegister128(ulong value) => new(value);

        /// <summary>Implicit conversion from int.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MixedFloatRegister128(int value) => new(value);

        /// <summary>Explicit conversion to BigInteger.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator BigInteger(MixedFloatRegister128 value) => value.ToBigInteger();

        /// <summary>Explicit conversion from BigInteger.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator MixedFloatRegister128(BigInteger value) => FromBigInteger(value);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator MixedFloatRegister128(UInt128 value) => new((ulong)(value & ulong.MaxValue), (ulong)(value >> 64));
        ...
        /// <summary>Creates a new MixedFloatRegister128 from a little-endian byte span.</summary>
        /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
        /// <exception cref="ArgumentException">The span is too short.</exception>
        public MixedFloatRegister128(ReadOnlySpan<byte> bytes)
        {
        ...
        /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
        /// <returns>The deserialized MixedFloatRegister128.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MixedFloatRegister128 ReadFrom(ReadOnlySpan<byte> bytes) => new(bytes);
        ...
        /// <summary>Parses a string into a MixedFloatRegister128. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        public static MixedFloatRegister128 Parse(string s, IFormatProvider? provider)
        {
        ...
        /// <summary>Tries to parse a string into a MixedFloatRegister128.</summary>
        public static bool TryParse(string? s, IFormatProvider? provider, out MixedFloatRegister128 result)
        {
        ...
        /// <summary>Parses a span of characters into a MixedFloatRegister128.</summary>
        public static MixedFloatRegister128 Parse(ReadOnlySpan<char> s, IFormatProvider? provider) => Parse(s.ToString(), provider);

        /// <summary>Tries to parse a span of characters into a MixedFloatRegister128.</summary>
        public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out MixedFloatRegister128 result) => TryParse(s.ToString(), provider, out result);

        /// <summary>Parses a string using invariant culture.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static MixedFloatRegister128 Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

        /// <summary>Tries to parse a string using invariant culture.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool TryParse(string? s, out MixedFloatRegister128 result) => TryParse(s, CultureInfo.InvariantCulture, out result);
        ...
        public readonly int CompareTo(object? obj)
        {
            ...
            if (obj is MixedFloatRegister128 other) return CompareTo(other);
            throw new ArgumentException("Object must be of type MixedFloatRegister128", nameof(obj));
        }

        /// <summary>Compares this instance to another MixedFloatRegister128.</summary>
        public readonly int CompareTo(MixedFloatRegister128 other)
        {
        ...
        /// <summary>Indicates whether this instance is equal to another MixedFloatRegister128.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(MixedFloatRegister128 other) => this == other;

        /// <summary>JSON converter that serializes MixedFloatRegister128 as a hex string.</summary>
        private sealed class MixedFloatRegister128JsonConverter : JsonConverter<MixedFloatRegister128>
        {
            /// <summary>Reads a MixedFloatRegister128 from a JSON string.</summary>
            public override MixedFloatRegister128 Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                return s is null ? default : MixedFloatRegister128.Parse(s);
            }

            /// <summary>Writes a MixedFloatRegister128 to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, MixedFloatRegister128 value, JsonSerializerOptions options)
            {
