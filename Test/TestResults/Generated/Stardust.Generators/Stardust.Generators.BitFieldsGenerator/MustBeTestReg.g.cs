                             ...
                             IFormattable, ISpanFormattable, IParsable<MustBeTestReg>, ISpanParsable<MustBeTestReg>
{
    ...
    public override readonly bool Equals(object? obj) => obj is MustBeTestReg other && __GetNormalizedValue() == other.__GetNormalizedValue();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(MustBeTestReg other) => __GetNormalizedValue().CompareTo(other.__GetNormalizedValue());
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(MustBeTestReg other) => __GetNormalizedValue() == other.__GetNormalizedValue();
