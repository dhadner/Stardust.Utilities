...
public partial class BitFieldTests
{
    public partial class Reg8_InternalClass
    {
                                     ...
                                     IFormattable, ISpanFormattable, IParsable<InternalReg8>, ISpanParsable<InternalReg8>
        {
            ...
            /// <summary>Creates a new InternalReg8 with the specified raw value.</summary>
            ...
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            public static InternalReg8 operator <<(InternalReg8 a, int b) => new(unchecked((byte)(a.Value << b)));
