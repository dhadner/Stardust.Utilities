                             ...
                             IFormattable, ISpanFormattable, IParsable<DescEscapeRegister>, ISpanParsable<DescEscapeRegister>
{
    ...
    public override readonly bool Equals(object? obj) => obj is DescEscapeRegister other && __value == other.__value;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(DescEscapeRegister other) => __value.CompareTo(other.__value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(DescEscapeRegister other) => __value == other.__value;
