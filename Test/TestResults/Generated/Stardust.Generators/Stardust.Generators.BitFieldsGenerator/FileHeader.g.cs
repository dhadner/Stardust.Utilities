                             ...
                             IFormattable, ISpanFormattable, IParsable<FileHeader>, ISpanParsable<FileHeader>
{
    ...
    public override readonly bool Equals(object? obj) => obj is FileHeader other && __value == other.__value;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(FileHeader other) => __value.CompareTo(other.__value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(FileHeader other) => __value == other.__value;
