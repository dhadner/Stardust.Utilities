...
public partial class BitFieldsViewTests
{
                                 ...
                                 IFormattable, ISpanFormattable, IParsable<EmbeddedFlags>, ISpanParsable<EmbeddedFlags>
    {
        ...
        public static EmbeddedFlags ActiveBit => new((byte)0x01);

        /// <summary>Returns a EmbeddedFlags with only the Valid bit set.</summary>
        public static EmbeddedFlags ValidBit => new((byte)0x02);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EmbeddedFlags WithActive(bool value) => new(value ? (byte)(Value | 0x01) : (byte)(Value & 0xFE));

        /// <summary>Returns a new EmbeddedFlags with the Valid flag set to the specified value.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EmbeddedFlags WithValid(bool value) => new(value ? (byte)(Value | 0x02) : (byte)(Value & 0xFD));

        /// <summary>Returns a new EmbeddedFlags with the Code field set to the specified value.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public EmbeddedFlags WithCode(byte value) => new((byte)((Value & 0x0F) | (((byte)value << 4) & 0xF0)));
