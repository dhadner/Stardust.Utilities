...
public partial class BitFieldSpecializationTests
{
    ...
    [JsonConverter(typeof(U128RegisterJsonConverter))]
    public partial struct U128Register : IComparable, IComparable<U128Register>, IEquatable<U128Register>,
                                 IFormattable, ISpanFormattable, IParsable<U128Register>, ISpanParsable<U128Register>
    {
        ...
        public static U128Register Default => default;
        ...
        public U128Register(ulong value) : this(value, 0UL) { }

        /// <summary>Creates a new U128Register from an int value. Negative values are sign-extended
        /// to all 128 bits (e.g., -1 sets all bits to 1).</summary>
        public U128Register(int value)
        {
        ...
        /// <summary>Returns a U128Register with the mask for the Low field (bits 0-63).</summary>
        public static U128Register LowMask => new(0xFFFFFFFFFFFFFFFFUL, 0UL);

        /// <summary>Returns a U128Register with the mask for the High field (bits 64-127).</summary>
        public static U128Register HighMask => new(0UL, 0xFFFFFFFFFFFFFFFFUL);

        /// <summary>Returns a new U128Register with the Low field set to the specified value.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public U128Register WithLow(ulong value) { var copy = this; copy.Low = value; return copy; }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U128Register operator ~(U128Register a) => new(~a.__w0, ~a.__w1);

        /// <summary>Bitwise OR operator.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U128Register operator |(U128Register a, U128Register b) => new(a.__w0 | b.__w0, a.__w1 | b.__w1);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U128Register operator &(U128Register a, ulong b) => new(a.__w0 & b, 0UL);

        /// <summary>Unary plus operator.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U128Register operator +(U128Register a) => a;

        /// <summary>Unary negation operator. Returns two's complement negation.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U128Register operator -(U128Register a) => ~a + new U128Register(1UL);

        /// <summary>Addition operator with carry propagation.</summary>
        public static U128Register operator +(U128Register a, U128Register b)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U128Register operator +(U128Register a, ulong b) => a + new U128Register(b);
        ...
        public static U128Register operator *(U128Register a, U128Register b) => FromBigInteger(a.ToBigInteger() * b.ToBigInteger());

        /// <summary>Multiplication operator with ulong.</summary>
        public static U128Register operator *(U128Register a, ulong b) => FromBigInteger(a.ToBigInteger() * b);

        /// <summary>Multiplication operator with ulong.</summary>
        public static U128Register operator *(ulong a, U128Register b) => FromBigInteger(a * b.ToBigInteger());
        ...
        public static U128Register operator <<(U128Register a, int amount)
        {
            if (amount <= 0) return a;
            if (amount >= __TOTAL_BITS) return default;
            int wordShift = amount / 64;
            int bitShift = amount % 64;
            var result = default(U128Register);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U128Register operator >>>(U128Register a, int amount) => a >> amount;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static ulong GetWord(U128Register v, int index)
        {
            return index switch
            {
                0 => v.__w0,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void SetWord(ref U128Register v, int index, ulong value)
        {
            switch (index)
            {
        ...
        public static bool operator <(U128Register a, U128Register b)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator >(U128Register a, U128Register b) => b < a;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator >=(U128Register a, U128Register b) => !(a < b);

        /// <summary>Equality operator.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(U128Register a, U128Register b) => a.__w0 == b.__w0 && a.__w1 == b.__w1;
        ...
        public override bool Equals(object? obj) => obj is U128Register other && this == other;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator U128Register(ulong value) => new(value);

        /// <summary>Implicit conversion from int.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator U128Register(int value) => new(value);

        /// <summary>Explicit conversion to BigInteger.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator BigInteger(U128Register value) => value.ToBigInteger();

        /// <summary>Explicit conversion from BigInteger.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator U128Register(BigInteger value) => FromBigInteger(value);

        /// <summary>Implicit conversion to UInt128.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator UInt128(U128Register value) => ((UInt128)value.__w1 << 64) | value.__w0;

        /// <summary>Implicit conversion from UInt128.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator U128Register(UInt128 value) => new((ulong)(value & ulong.MaxValue), (ulong)(value >> 64));
        ...
        /// <summary>Creates a U128Register from a BigInteger (truncated to 128 bits).</summary>
        public static U128Register FromBigInteger(BigInteger value)
        {
        ...
        /// <summary>Creates a new U128Register from a little-endian byte span.</summary>
        /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
        /// <exception cref="ArgumentException">The span is too short.</exception>
        public U128Register(ReadOnlySpan<byte> bytes)
        {
        ...
        /// <summary>Creates a new U128Register by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
        /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
        /// <returns>The deserialized U128Register.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U128Register ReadFrom(ReadOnlySpan<byte> bytes) => new(bytes);
        ...
        /// <summary>Parses a string into a U128Register. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        public static U128Register Parse(string s, IFormatProvider? provider)
        {
        ...
        /// <summary>Tries to parse a string into a U128Register.</summary>
        public static bool TryParse(string? s, IFormatProvider? provider, out U128Register result)
        {
        ...
        /// <summary>Parses a span of characters into a U128Register.</summary>
        public static U128Register Parse(ReadOnlySpan<char> s, IFormatProvider? provider) => Parse(s.ToString(), provider);

        /// <summary>Tries to parse a span of characters into a U128Register.</summary>
        public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out U128Register result) => TryParse(s.ToString(), provider, out result);

        /// <summary>Parses a string using invariant culture.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static U128Register Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

        /// <summary>Tries to parse a string using invariant culture.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool TryParse(string? s, out U128Register result) => TryParse(s, CultureInfo.InvariantCulture, out result);
        ...
        public int CompareTo(object? obj)
        {
            ...
            if (obj is U128Register other) return CompareTo(other);
            throw new ArgumentException("Object must be of type U128Register", nameof(obj));
        }

        /// <summary>Compares this instance to another U128Register.</summary>
        public int CompareTo(U128Register other)
        {
        ...
        /// <summary>Indicates whether this instance is equal to another U128Register.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(U128Register other) => this == other;

        /// <summary>JSON converter that serializes U128Register as a hex string.</summary>
        private sealed class U128RegisterJsonConverter : JsonConverter<U128Register>
        {
            /// <summary>Reads a U128Register from a JSON string.</summary>
            public override U128Register Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                return s is null ? default : U128Register.Parse(s);
            }

            /// <summary>Writes a U128Register to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, U128Register value, JsonSerializerOptions options)
            {
