...
public partial class BitFieldSpecializationTests
{
    ...
    [JsonConverter(typeof(I128RegisterJsonConverter))]
                                 ...
                                 IFormattable, ISpanFormattable, IParsable<I128Register>, ISpanParsable<I128Register>
    {
        ...
        /// <summary>Creates a new I128Register from individual word values.</summary>
        public I128Register(ulong w0, ulong w1)
        {
            _w0 = w0;
            _w1 = w1;
        }
        ...
        public I128Register(ulong value) : this(value, 0UL) { }

        /// <summary>Creates a new I128Register from an int value. Negative values are sign-extended
        /// to all 128 bits (e.g., -1 sets all bits to 1).</summary>
        public I128Register(int value)
        {
        ...
        public static I128Register LowMask => new(0xFFFFFFFFFFFFFFFFUL, 0UL);

        /// <summary>Returns a I128Register with the mask for the High field (bits 64-127).</summary>
        public static I128Register HighMask => new(0UL, 0xFFFFFFFFFFFFFFFFUL);

        /// <summary>Returns a new I128Register with the Low field set to the specified value.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public I128Register WithLow(ulong value) { var copy = this; copy.Low = value; return copy; }

        /// <summary>Returns a new I128Register with the High field set to the specified value.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I128Register operator +(I128Register a) => a;

        /// <summary>Unary negation operator. Returns two's complement negation.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I128Register operator -(I128Register a) => ~a + new I128Register(1UL);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I128Register operator +(I128Register a, ulong b) => a + new I128Register(b);
        ...
        public static I128Register operator *(I128Register a, I128Register b) => FromBigInteger(a.ToBigInteger() * b.ToBigInteger());

        /// <summary>Multiplication operator with ulong.</summary>
        public static I128Register operator *(I128Register a, ulong b) => FromBigInteger(a.ToBigInteger() * b);

        /// <summary>Multiplication operator with ulong.</summary>
        public static I128Register operator *(ulong a, I128Register b) => FromBigInteger(a * b.ToBigInteger());
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I128Register operator >>>(I128Register a, int amount) => a >> amount;

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static ulong GetWord(I128Register v, int index)
        {
            return index switch
            {
                0 => v._w0,
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static void SetWord(ref I128Register v, int index, ulong value)
        {
            switch (index)
            {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator >(I128Register a, I128Register b) => b < a;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator >=(I128Register a, I128Register b) => !(a < b);
        ...
        public override bool Equals(object? obj) => obj is I128Register other && this == other;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator I128Register(ulong value) => new(value);

        /// <summary>Implicit conversion from int.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator I128Register(int value) => new(value);

        /// <summary>Explicit conversion to BigInteger.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator BigInteger(I128Register value) => value.ToBigInteger();

        /// <summary>Explicit conversion from BigInteger.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator I128Register(BigInteger value) => FromBigInteger(value);
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator I128Register(Int128 value) { var u = (UInt128)value; return new((ulong)(u & ulong.MaxValue), (ulong)(u >> 64)); }
        ...
        /// <summary>Creates a new I128Register from a little-endian byte span.</summary>
        /// <param name="bytes">The source span. Must contain at least <see cref="SizeInBytes"/> bytes.</param>
        /// <exception cref="ArgumentException">The span is too short.</exception>
        public I128Register(ReadOnlySpan<byte> bytes)
        {
        ...
        /// <summary>Creates a new I128Register by reading <see cref="SizeInBytes"/> bytes from a little-endian byte span.</summary>
        /// <param name="bytes">The source span. Must contain at least <see cref="SizeInBytes"/> bytes.</param>
        /// <returns>The deserialized I128Register.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I128Register ReadFrom(ReadOnlySpan<byte> bytes) => new(bytes);
        ...
        /// <summary>Parses a string into a I128Register. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
        public static I128Register Parse(string s, IFormatProvider? provider)
        {
        ...
        /// <summary>Tries to parse a string into a I128Register.</summary>
        public static bool TryParse(string? s, IFormatProvider? provider, out I128Register result)
        {
        ...
        /// <summary>Parses a span of characters into a I128Register.</summary>
        public static I128Register Parse(ReadOnlySpan<char> s, IFormatProvider? provider) => Parse(s.ToString(), provider);

        /// <summary>Tries to parse a span of characters into a I128Register.</summary>
        public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out I128Register result) => TryParse(s.ToString(), provider, out result);

        /// <summary>Parses a string using invariant culture.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static I128Register Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

        /// <summary>Tries to parse a string using invariant culture.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool TryParse(string? s, out I128Register result) => TryParse(s, CultureInfo.InvariantCulture, out result);
        ...
        public int CompareTo(object? obj)
        {
            ...
            if (obj is I128Register other) return CompareTo(other);
            throw new ArgumentException("Object must be of type I128Register", nameof(obj));
        }
        ...
        /// <summary>Indicates whether this instance is equal to another I128Register.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(I128Register other) => this == other;

        /// <summary>JSON converter that serializes I128Register as a hex string.</summary>
        private sealed class I128RegisterJsonConverter : JsonConverter<I128Register>
        {
            /// <summary>Reads a I128Register from a JSON string.</summary>
            public override I128Register Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                return s is null ? default : I128Register.Parse(s);
            }

            /// <summary>Writes a I128Register to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, I128Register value, JsonSerializerOptions options)
            {
