...
[JsonConverter(typeof(SignedPropertyRegSigned16JsonConverter))]
                             ...
                             IFormattable, ISpanFormattable, IParsable<SignedPropertyRegSigned16>, ISpanParsable<SignedPropertyRegSigned16>
{
    ...
    public static ReadOnlySpan<BitFieldInfo> Fields => new BitFieldInfo[]
    {
        ...
        new("SignedNibble", 9, 4, "sbyte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 16, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
    };
    ...
    public override readonly bool Equals(object? obj) => obj is SignedPropertyRegSigned16 other && __value == other.__value;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(SignedPropertyRegSigned16 other) => __value.CompareTo(other.__value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(SignedPropertyRegSigned16 other) => __value == other.__value;
    ...
    {
        /// <summary>Reads a SignedPropertyRegSigned16 from a JSON string.</summary>
        public override SignedPropertyRegSigned16 Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var s = reader.GetString();
            return s is null ? default : SignedPropertyRegSigned16.Parse(s);
        }

        /// <summary>Writes a SignedPropertyRegSigned16 to JSON as a string.</summary>
        public override void Write(Utf8JsonWriter writer, SignedPropertyRegSigned16 value, JsonSerializerOptions options)
        {
