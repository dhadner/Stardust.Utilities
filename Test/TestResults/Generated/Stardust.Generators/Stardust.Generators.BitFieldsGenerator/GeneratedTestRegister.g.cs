...
[JsonConverter(typeof(GeneratedTestRegisterJsonConverter))]
public partial struct GeneratedTestRegister : IComparable, IComparable<GeneratedTestRegister>, IEquatable<GeneratedTestRegister>,
                             IFormattable, ISpanFormattable, IParsable<GeneratedTestRegister>, ISpanParsable<GeneratedTestRegister>
{
    ...
    public GeneratedTestRegister(byte value) { __value = value; }

    public partial byte Mode
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        get => (byte)((__value >> __MODE_START_BIT) & __MODE_MASK);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    {
        new("Mode", 2, 3, "byte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 8, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GeneratedTestRegister WithReady(bool value) => new(value ? (byte)(__value | __READY_MASK) : (byte)(__value & __READY_INVERTED_MASK));

    /// <summary>Returns a new GeneratedTestRegister with the Error flag set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GeneratedTestRegister WithError(bool value) => new(value ? (byte)(__value | __ERROR_MASK) : (byte)(__value & __ERROR_INVERTED_MASK));

    /// <summary>Returns a new GeneratedTestRegister with the Busy flag set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GeneratedTestRegister WithBusy(bool value) => new(value ? (byte)(__value | __BUSY_MASK) : (byte)(__value & __BUSY_INVERTED_MASK));

    /// <summary>Returns a new GeneratedTestRegister with the Mode field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GeneratedTestRegister WithMode(byte value) => new((byte)((__value & __MODE_INVERTED_MASK) | (((byte)value << __MODE_START_BIT) & __MODE_SHIFTED_MASK)));

    /// <summary>Returns a new GeneratedTestRegister with the Priority field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GeneratedTestRegister WithPriority(byte value) => new((byte)((__value & __PRIORITY_INVERTED_MASK) | (((byte)value << __PRIORITY_START_BIT) & __PRIORITY_SHIFTED_MASK)));

    /// <summary>Bitwise complement operator.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GeneratedTestRegister operator ~(GeneratedTestRegister a) => new((byte)~a.__value);

    /// <summary>Bitwise OR operator.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GeneratedTestRegister operator |(GeneratedTestRegister a, GeneratedTestRegister b) => new((byte)(a.__value | b.__value));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GeneratedTestRegister operator +(GeneratedTestRegister a) => a;

    /// <summary>Unary negation operator. Returns two's complement negation.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GeneratedTestRegister operator -(GeneratedTestRegister a) => new(unchecked((byte)(0 - a.__value)));

    /// <summary>Addition operator.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GeneratedTestRegister operator +(GeneratedTestRegister a, GeneratedTestRegister b) => new(unchecked((byte)(a.__value + b.__value)));

    /// <summary>Addition operator with storage type.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GeneratedTestRegister operator +(GeneratedTestRegister a, byte b) => new(unchecked((byte)(a.__value + b)));

    /// <summary>Addition operator with storage type.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GeneratedTestRegister operator +(byte a, GeneratedTestRegister b) => new(unchecked((byte)(a + b.__value)));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GeneratedTestRegister operator /(GeneratedTestRegister a, byte b) => new((byte)(a.__value / b));

    /// <summary>Division operator with storage type.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GeneratedTestRegister operator /(byte a, GeneratedTestRegister b) => new((byte)(a / b.__value));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static int operator <<(GeneratedTestRegister a, int b) => a.__value << b;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator <(GeneratedTestRegister a, GeneratedTestRegister b) => a.__value < b.__value;
    ...
    public override readonly bool Equals(object? obj) => obj is GeneratedTestRegister other && __value == other.__value;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator byte(GeneratedTestRegister value) => value.__value;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GeneratedTestRegister(byte value) => new(value);
    ...
    /// <summary>Parses a string into a GeneratedTestRegister. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <returns>The parsed GeneratedTestRegister value.</returns>
    /// <exception cref="ArgumentNullException">s is null.</exception>
    public static GeneratedTestRegister Parse(string s, IFormatProvider? provider)
    {
    ...
    /// <summary>Tries to parse a string into a GeneratedTestRegister. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    public static bool TryParse(string? s, IFormatProvider? provider, out GeneratedTestRegister result)
    {
    ...
    /// <summary>Parses a span of characters into a GeneratedTestRegister. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The span of characters to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <returns>The parsed GeneratedTestRegister value.</returns>
    public static GeneratedTestRegister Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
    {
        if (IsBinaryPrefix(s))
    ...
    /// <summary>Tries to parse a span of characters into a GeneratedTestRegister. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The span of characters to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out GeneratedTestRegister result)
    {
        if (IsBinaryPrefix(s))
        {
    ...
    /// <summary>Parses a string into a GeneratedTestRegister using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <returns>The parsed GeneratedTestRegister value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GeneratedTestRegister Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

    /// <summary>Tries to parse a string into a GeneratedTestRegister using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool TryParse(string? s, out GeneratedTestRegister result) => TryParse(s, CultureInfo.InvariantCulture, out result);
    ...
    /// <exception cref="ArgumentException">obj is not a GeneratedTestRegister.</exception>
    public readonly int CompareTo(object? obj)
    {
        if (obj is null) return 1;
        if (obj is GeneratedTestRegister other) return CompareTo(other);
        throw new ArgumentException("Object must be of type GeneratedTestRegister", nameof(obj));
    }

    /// <summary>Compares this instance to another GeneratedTestRegister and returns an integer indicating their relative order.</summary>
    /// <param name="other">A GeneratedTestRegister to compare.</param>
    /// <returns>A value indicating the relative order of the instances being compared.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(GeneratedTestRegister other) => __value.CompareTo(other.__value);

    /// <summary>Indicates whether this instance is equal to another GeneratedTestRegister.</summary>
    /// <param name="other">A GeneratedTestRegister to compare with this instance.</param>
    /// <returns>true if the two instances are equal; otherwise, false.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(GeneratedTestRegister other) => __value == other.__value;

    /// <summary>JSON converter that serializes GeneratedTestRegister as a string.</summary>
    private sealed class GeneratedTestRegisterJsonConverter : JsonConverter<GeneratedTestRegister>
    {
        /// <summary>Reads a GeneratedTestRegister from a JSON string.</summary>
        public override GeneratedTestRegister Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var s = reader.GetString();
            return s is null ? default : GeneratedTestRegister.Parse(s);
        }

        /// <summary>Writes a GeneratedTestRegister to JSON as a string.</summary>
        public override void Write(Utf8JsonWriter writer, GeneratedTestRegister value, JsonSerializerOptions options)
        {
