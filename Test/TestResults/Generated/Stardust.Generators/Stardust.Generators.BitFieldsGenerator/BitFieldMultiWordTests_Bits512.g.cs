...
public partial class BitFieldMultiWordTests
{
                                 ...
                                 IFormattable, ISpanFormattable, IParsable<Bits512>, ISpanParsable<Bits512>
    {
        ...
        public partial bool MidFlag
        {
            ...
            get => (__w4 & 0x1UL) != 0;
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => __w4 = value ? (__w4 | 0x1UL) : (__w4 & 0xFFFFFFFFFFFFFFFEUL);
        }
        ...
        {
            new("W0", 0, 64, "ulong", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 512, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
            new("W1", 64, 64, "ulong", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 512, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
            new("W7", 448, 64, "ulong", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 512, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
            new("MidFlag", 256, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 512, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        };
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(Bits512 a, Bits512 b) => a.__w0 == b.__w0 && a.__w1 == b.__w1 && a.__w2 == b.__w2 && a.__w3 == b.__w3 && a.__w4 == b.__w4 && a.__w5 == b.__w5 && a.__w6 == b.__w6 && a.__w7 == b.__w7;
        ...
        public override readonly bool Equals(object? obj) => obj is Bits512 other && this == other;
        ...
        /// <summary>Creates a new Bits512 by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
        /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
        ...
        public readonly int CompareTo(Bits512 other)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(Bits512 other) => this == other;
