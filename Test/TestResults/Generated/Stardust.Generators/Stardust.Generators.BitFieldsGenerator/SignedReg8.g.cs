                             ...
                             IFormattable, ISpanFormattable, IParsable<SignedReg8>, ISpanParsable<SignedReg8>
{
    ...
    public override readonly bool Equals(object? obj) => obj is SignedReg8 other && __value == other.__value;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(SignedReg8 other) => __value.CompareTo(other.__value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(SignedReg8 other) => __value == other.__value;
