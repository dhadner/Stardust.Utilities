...
[JsonConverter(typeof(TelemetryFrame512JsonConverter))]
public partial struct TelemetryFrame512 : IComparable, IComparable<TelemetryFrame512>, IEquatable<TelemetryFrame512>,
                             IFormattable, ISpanFormattable, IParsable<TelemetryFrame512>, ISpanParsable<TelemetryFrame512>
{
    ...
    /// <summary>Creates a new TelemetryFrame512 from an int value. Negative values are sign-extended
    /// to all 512 bits (e.g., -1 sets all bits to 1).</summary>
    public TelemetryFrame512(int value)
    {
    ...
    public partial global::Stardust.Utilities.Tests.GuidBits128 Id
    {
        get
        {
            ...
            WriteTo(__buf);
            return global::Stardust.Utilities.Tests.GuidBits128.ReadFrom(__buf.Slice(0, 16));
        }
        set
        {
            Span<byte> __buf = stackalloc byte[SIZE_IN_BYTES];
            WriteTo(__buf);
            value.WriteTo(__buf.Slice(0, 16));
            this = ReadFrom(__buf);
        }
    }
    ...
    public partial global::Stardust.Utilities.Tests.WidePayload256 Payload
    {
        get
        {
            Span<byte> __buf = stackalloc byte[SIZE_IN_BYTES];
            WriteTo(__buf);
            return global::Stardust.Utilities.Tests.WidePayload256.ReadFrom(__buf.Slice(16, 32));
        }
        set
        {
            Span<byte> __buf = stackalloc byte[SIZE_IN_BYTES];
            WriteTo(__buf);
            value.WriteTo(__buf.Slice(16, 32));
            this = ReadFrom(__buf);
        }
    }

    public partial global::Stardust.Utilities.Tests.DecimalPayload128 Footer
    {
        get
        {
            Span<byte> __buf = stackalloc byte[SIZE_IN_BYTES];
            WriteTo(__buf);
            return global::Stardust.Utilities.Tests.DecimalPayload128.ReadFrom(__buf.Slice(48, 16));
        }
        set
        {
            Span<byte> __buf = stackalloc byte[SIZE_IN_BYTES];
            WriteTo(__buf);
            value.WriteTo(__buf.Slice(48, 16));
            this = ReadFrom(__buf);
        }
    }

    /// <summary>Returns a TelemetryFrame512 with the mask for the Id field (bits 0-127).</summary>
    public static TelemetryFrame512 IdMask
    {
        get
        {
            var result = default(TelemetryFrame512);
    ...
    /// <summary>Returns a TelemetryFrame512 with the mask for the Payload field (bits 128-383).</summary>
    public static TelemetryFrame512 PayloadMask
    {
        get
        {
            var result = default(TelemetryFrame512);
            result.__w0 = 0UL;
            result.__w1 = 0UL;
            result.__w2 = 0xFFFFFFFFFFFFFFFFUL;
            result.__w3 = 0xFFFFFFFFFFFFFFFFUL;
            result.__w4 = 0xFFFFFFFFFFFFFFFFUL;
            result.__w5 = 0xFFFFFFFFFFFFFFFFUL;
            result.__w6 = 0UL;
            result.__w7 = 0UL;
            return result;
        }
    ...
    /// <summary>Returns a TelemetryFrame512 with the mask for the Footer field (bits 384-511).</summary>
    public static TelemetryFrame512 FooterMask
    {
        get
        {
            var result = default(TelemetryFrame512);
            ...
            result.__w4 = 0UL;
            result.__w5 = 0UL;
            result.__w6 = 0xFFFFFFFFFFFFFFFFUL;
            result.__w7 = 0xFFFFFFFFFFFFFFFFUL;
            return result;
        }
    }

    /// <summary>Returns a new TelemetryFrame512 with the Id field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TelemetryFrame512 WithId(global::Stardust.Utilities.Tests.GuidBits128 value) { var copy = this; copy.Id = value; return copy; }

    /// <summary>Returns a new TelemetryFrame512 with the Payload field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TelemetryFrame512 WithPayload(global::Stardust.Utilities.Tests.WidePayload256 value) { var copy = this; copy.Payload = value; return copy; }

    /// <summary>Returns a new TelemetryFrame512 with the Footer field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public TelemetryFrame512 WithFooter(global::Stardust.Utilities.Tests.DecimalPayload128 value) { var copy = this; copy.Footer = value; return copy; }
    ...
    {
        new("Id", 0, 128, "Stardust.Utilities.Tests.GuidBits128", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 512, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        new("Payload", 128, 256, "Stardust.Utilities.Tests.WidePayload256", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 512, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        new("Footer", 384, 128, "Stardust.Utilities.Tests.DecimalPayload128", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 512, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
    };

    /// <summary>Bitwise complement operator.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TelemetryFrame512 operator ~(TelemetryFrame512 a)
    {
        var result = default(TelemetryFrame512);
        result.__w0 = ~a.__w0;
        result.__w1 = ~a.__w1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TelemetryFrame512 operator |(TelemetryFrame512 a, TelemetryFrame512 b)
    {
        var result = default(TelemetryFrame512);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TelemetryFrame512 operator &(TelemetryFrame512 a, ulong b)
    {
        var result = default(TelemetryFrame512);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TelemetryFrame512 operator +(TelemetryFrame512 a) => a;

    /// <summary>Unary negation operator. Returns two's complement negation.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TelemetryFrame512 operator -(TelemetryFrame512 a) => ~a + new TelemetryFrame512(1UL);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TelemetryFrame512 operator +(TelemetryFrame512 a, ulong b) => a + new TelemetryFrame512(b);
    ...
    public static TelemetryFrame512 operator *(TelemetryFrame512 a, TelemetryFrame512 b) => FromBigInteger(a.ToBigInteger() * b.ToBigInteger());

    /// <summary>Multiplication operator with ulong.</summary>
    public static TelemetryFrame512 operator *(TelemetryFrame512 a, ulong b) => FromBigInteger(a.ToBigInteger() * b);

    /// <summary>Multiplication operator with ulong.</summary>
    public static TelemetryFrame512 operator *(ulong a, TelemetryFrame512 b) => FromBigInteger(a * b.ToBigInteger());
    ...
    public static TelemetryFrame512 operator <<(TelemetryFrame512 a, int amount)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TelemetryFrame512 operator >>>(TelemetryFrame512 a, int amount) => a >> amount;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static ulong GetWord(TelemetryFrame512 v, int index)
    {
        return index switch
        {
            0 => v.__w0,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static void SetWord(ref TelemetryFrame512 v, int index, ulong value)
    {
        switch (index)
        {
    ...
    public static bool operator <(TelemetryFrame512 a, TelemetryFrame512 b)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator >(TelemetryFrame512 a, TelemetryFrame512 b) => b < a;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator >=(TelemetryFrame512 a, TelemetryFrame512 b) => !(a < b);

    /// <summary>Equality operator.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(TelemetryFrame512 a, TelemetryFrame512 b) => a.__w0 == b.__w0 && a.__w1 == b.__w1 && a.__w2 == b.__w2 && a.__w3 == b.__w3 && a.__w4 == b.__w4 && a.__w5 == b.__w5 && a.__w6 == b.__w6 && a.__w7 == b.__w7;
    ...
    public override readonly bool Equals(object? obj) => obj is TelemetryFrame512 other && this == other;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator TelemetryFrame512(ulong value) => new(value);

    /// <summary>Implicit conversion from int.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator TelemetryFrame512(int value) => new(value);

    /// <summary>Explicit conversion to BigInteger.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator BigInteger(TelemetryFrame512 value) => value.ToBigInteger();

    /// <summary>Explicit conversion from BigInteger.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator TelemetryFrame512(BigInteger value) => FromBigInteger(value);
    ...
    /// <summary>Creates a TelemetryFrame512 from a BigInteger (truncated to 512 bits).</summary>
    public static TelemetryFrame512 FromBigInteger(BigInteger value)
    {
    ...
    /// <summary>Creates a new TelemetryFrame512 from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    /// <exception cref="ArgumentException">The span is too short.</exception>
    public TelemetryFrame512(ReadOnlySpan<byte> bytes)
    {
    ...
    /// <summary>Creates a new TelemetryFrame512 by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    /// <returns>The deserialized TelemetryFrame512.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TelemetryFrame512 ReadFrom(ReadOnlySpan<byte> bytes) => new(bytes);
    ...
    /// <summary>Parses a string into a TelemetryFrame512. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    public static TelemetryFrame512 Parse(string s, IFormatProvider? provider)
    {
    ...
    /// <summary>Tries to parse a string into a TelemetryFrame512.</summary>
    public static bool TryParse(string? s, IFormatProvider? provider, out TelemetryFrame512 result)
    {
    ...
    /// <summary>Parses a span of characters into a TelemetryFrame512.</summary>
    public static TelemetryFrame512 Parse(ReadOnlySpan<char> s, IFormatProvider? provider) => Parse(s.ToString(), provider);

    /// <summary>Tries to parse a span of characters into a TelemetryFrame512.</summary>
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out TelemetryFrame512 result) => TryParse(s.ToString(), provider, out result);

    /// <summary>Parses a string using invariant culture.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static TelemetryFrame512 Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

    /// <summary>Tries to parse a string using invariant culture.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool TryParse(string? s, out TelemetryFrame512 result) => TryParse(s, CultureInfo.InvariantCulture, out result);
    ...
    public readonly int CompareTo(object? obj)
    {
        ...
        if (obj is TelemetryFrame512 other) return CompareTo(other);
        throw new ArgumentException("Object must be of type TelemetryFrame512", nameof(obj));
    }

    /// <summary>Compares this instance to another TelemetryFrame512.</summary>
    public readonly int CompareTo(TelemetryFrame512 other)
    {
    ...
    /// <summary>Indicates whether this instance is equal to another TelemetryFrame512.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(TelemetryFrame512 other) => this == other;

    /// <summary>JSON converter that serializes TelemetryFrame512 as a hex string.</summary>
    private sealed class TelemetryFrame512JsonConverter : JsonConverter<TelemetryFrame512>
    {
        /// <summary>Reads a TelemetryFrame512 from a JSON string.</summary>
        public override TelemetryFrame512 Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var s = reader.GetString();
            return s is null ? default : TelemetryFrame512.Parse(s);
        }

        /// <summary>Writes a TelemetryFrame512 to JSON as a hex string.</summary>
        public override void Write(Utf8JsonWriter writer, TelemetryFrame512 value, JsonSerializerOptions options)
        {
