                             ...
                             IFormattable, ISpanFormattable, IParsable<AutoSizedUndefinedZeroes>, ISpanParsable<AutoSizedUndefinedZeroes>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] private readonly byte __GetNormalizedValue() => (byte)(__value & __NORMALIZATION_AND_MASK);
    ...
    public override readonly bool Equals(object? obj) => obj is AutoSizedUndefinedZeroes other && __GetNormalizedValue() == other.__GetNormalizedValue();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(AutoSizedUndefinedZeroes other) => __GetNormalizedValue().CompareTo(other.__GetNormalizedValue());
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(AutoSizedUndefinedZeroes other) => __GetNormalizedValue() == other.__GetNormalizedValue();
