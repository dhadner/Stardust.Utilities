                             ...
                             IFormattable, ISpanFormattable, IParsable<GeneratedStatusReg8>, ISpanParsable<GeneratedStatusReg8>
{
    ...
    public static GeneratedStatusReg8 ReadyBit { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(__READY_MASK); }

    /// <summary>Returns a GeneratedStatusReg8 with only the Error bit set.</summary>
    public static GeneratedStatusReg8 ErrorBit { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(__ERROR_MASK); }

    /// <summary>Returns a GeneratedStatusReg8 with only the Busy bit set.</summary>
    public static GeneratedStatusReg8 BusyBit { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(__BUSY_MASK); }

    /// <summary>Returns a GeneratedStatusReg8 with the mask for the Mode field (bits 2-4).</summary>
    public static GeneratedStatusReg8 ModeMask { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(__MODE_SHIFTED_MASK); }

    /// <summary>Returns a GeneratedStatusReg8 with the mask for the Priority field (bits 5-6).</summary>
    public static GeneratedStatusReg8 PriorityMask { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(__PRIORITY_SHIFTED_MASK); }
    ...
    public override readonly bool Equals(object? obj) => obj is GeneratedStatusReg8 other && __value == other.__value;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(GeneratedStatusReg8 other) => __value.CompareTo(other.__value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(GeneratedStatusReg8 other) => __value == other.__value;
