...
[JsonConverter(typeof(ProtocolHeader32JsonConverter))]
                             ...
                             IFormattable, ISpanFormattable, IParsable<ProtocolHeader32>, ISpanParsable<ProtocolHeader32>
{
    ...
    {
        new("Status", 0, 8, "Stardust.Utilities.Tests.StatusFlags", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 32, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        new("Command", 8, 4, "Stardust.Utilities.Tests.CommandCode", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 32, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        new("Version", 12, 4, "byte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 32, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        new("Sequence", 16, 16, "ushort", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 32, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
    };
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ProtocolHeader32 operator +(ProtocolHeader32 a) => a;
    ...
    public override readonly bool Equals(object? obj) => obj is ProtocolHeader32 other && __value == other.__value;
    ...
    /// <summary>Parses a string into a ProtocolHeader32. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <returns>The parsed ProtocolHeader32 value.</returns>
    /// <exception cref="ArgumentNullException">s is null.</exception>
    public static ProtocolHeader32 Parse(string s, IFormatProvider? provider)
    {
    ...
    /// <summary>Tries to parse a string into a ProtocolHeader32. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    public static bool TryParse(string? s, IFormatProvider? provider, out ProtocolHeader32 result)
    {
    ...
    /// <summary>Parses a span of characters into a ProtocolHeader32. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The span of characters to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <returns>The parsed ProtocolHeader32 value.</returns>
    public static ProtocolHeader32 Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
    {
        if (IsBinaryPrefix(s))
    ...
    /// <summary>Tries to parse a span of characters into a ProtocolHeader32. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The span of characters to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out ProtocolHeader32 result)
    {
        if (IsBinaryPrefix(s))
        {
    ...
    /// <summary>Parses a string into a ProtocolHeader32 using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <returns>The parsed ProtocolHeader32 value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ProtocolHeader32 Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

    /// <summary>Tries to parse a string into a ProtocolHeader32 using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool TryParse(string? s, out ProtocolHeader32 result) => TryParse(s, CultureInfo.InvariantCulture, out result);
    ...
    /// <exception cref="ArgumentException">obj is not a ProtocolHeader32.</exception>
    public readonly int CompareTo(object? obj)
    {
        if (obj is null) return 1;
        if (obj is ProtocolHeader32 other) return CompareTo(other);
        throw new ArgumentException("Object must be of type ProtocolHeader32", nameof(obj));
    }

    /// <summary>Compares this instance to another ProtocolHeader32 and returns an integer indicating their relative order.</summary>
    /// <param name="other">A ProtocolHeader32 to compare.</param>
    /// <returns>A value indicating the relative order of the instances being compared.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(ProtocolHeader32 other) => __value.CompareTo(other.__value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(ProtocolHeader32 other) => __value == other.__value;
    ...
    {
        /// <summary>Reads a ProtocolHeader32 from a JSON string.</summary>
        public override ProtocolHeader32 Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var s = reader.GetString();
            return s is null ? default : ProtocolHeader32.Parse(s);
        }

        /// <summary>Writes a ProtocolHeader32 to JSON as a string.</summary>
        public override void Write(Utf8JsonWriter writer, ProtocolHeader32 value, JsonSerializerOptions options)
        {
