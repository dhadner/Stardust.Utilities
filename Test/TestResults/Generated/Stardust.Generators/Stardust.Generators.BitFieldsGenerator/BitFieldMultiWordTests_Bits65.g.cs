...
public partial class BitFieldMultiWordTests
{
                                 ...
                                 IFormattable, ISpanFormattable, IParsable<Bits65>, ISpanParsable<Bits65>
    {
        ...
        private const int __TOTAL_BITS = 65;

        /// <summary>Size of this struct in bytes.</summary>
        public const int SIZE_IN_BYTES = 9;
        /// <summary>Total number of bits in this struct.</summary>
        public const int BIT_WIDTH = 65;

        private const ulong __LAST_WORD_MASK = 0x0000000000000001UL;
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => (((ulong)__w1) & 0x1UL) != 0;
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set => __w1 = (byte)(value ? (((ulong)__w1) | 0x1UL) : (((ulong)__w1) & 0xFFFFFFFFFFFFFFFEUL));
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Bits65 WithExtraBit(bool value) => new(__w0, (byte)(value ? (((ulong)__w1) | 0x1UL) : (((ulong)__w1) & 0xFFFFFFFFFFFFFFFEUL)));
        ...
        {
            new("Low", 0, 64, "ulong", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 65, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
            new("ExtraBit", 64, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 65, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        };

        /// <summary>Bitwise complement operator.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Bits65 operator ~(Bits65 a) => new(~a.__w0, (byte)(~((ulong)a.__w1)));

        /// <summary>Bitwise OR operator.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Bits65 operator |(Bits65 a, Bits65 b) => new(a.__w0 | b.__w0, (byte)(((ulong)a.__w1) | ((ulong)b.__w1)));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Bits65 operator &(Bits65 a, ulong b) => new(a.__w0 & b, default(byte));
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(Bits65 a, Bits65 b) => a.__w0 == b.__w0 && a.__w1 == b.__w1;
        ...
        public override readonly bool Equals(object? obj) => obj is Bits65 other && this == other;
        ...
        /// <summary>Creates a new Bits65 by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
        /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
        ...
        public readonly int CompareTo(Bits65 other)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public readonly bool Equals(Bits65 other) => this == other;
