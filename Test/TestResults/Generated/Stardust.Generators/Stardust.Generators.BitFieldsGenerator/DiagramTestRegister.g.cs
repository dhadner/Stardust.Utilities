                             ...
                             IFormattable, ISpanFormattable, IParsable<DiagramTestRegister>, ISpanParsable<DiagramTestRegister>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public DiagramTestRegister WithMode(byte value) => new((byte)((Value & MODE_INVERTED_MASK) | (((byte)value << 2) & MODE_SHIFTED_MASK)));

    /// <summary>Returns a new DiagramTestRegister with the Priority field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public DiagramTestRegister WithPriority(byte value) => new((byte)((Value & PRIORITY_INVERTED_MASK) | (((byte)value << 5) & PRIORITY_SHIFTED_MASK)));
