                             ...
                             IFormattable, ISpanFormattable, IParsable<DiagramTestRegister>, ISpanParsable<DiagramTestRegister>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public DiagramTestRegister WithReady(bool value) => new(value ? (byte)(Value | READY_MASK) : (byte)(Value & READY_INVERTED_MASK));

    /// <summary>Returns a new DiagramTestRegister with the Error flag set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public DiagramTestRegister WithError(bool value) => new(value ? (byte)(Value | ERROR_MASK) : (byte)(Value & ERROR_INVERTED_MASK));

    /// <summary>Returns a new DiagramTestRegister with the Busy flag set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public DiagramTestRegister WithBusy(bool value) => new(value ? (byte)(Value | BUSY_MASK) : (byte)(Value & BUSY_INVERTED_MASK));

    /// <summary>Returns a new DiagramTestRegister with the Mode field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public DiagramTestRegister WithMode(byte value) => new((byte)((Value & MODE_INVERTED_MASK) | (((byte)value << MODE_START_BIT) & MODE_SHIFTED_MASK)));

    /// <summary>Returns a new DiagramTestRegister with the Priority field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public DiagramTestRegister WithPriority(byte value) => new((byte)((Value & PRIORITY_INVERTED_MASK) | (((byte)value << PRIORITY_START_BIT) & PRIORITY_SHIFTED_MASK)));
