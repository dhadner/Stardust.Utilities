                             ...
                             IFormattable, ISpanFormattable, IParsable<DiagramTestRegister>, ISpanParsable<DiagramTestRegister>
{
    ...
    public DiagramTestRegister(byte value) { __value = value; }
    ...
    public static DiagramTestRegister ReadyBit { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(__READY_MASK); }

    /// <summary>Returns a DiagramTestRegister with only the Error bit set.</summary>
    public static DiagramTestRegister ErrorBit { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(__ERROR_MASK); }

    /// <summary>Returns a DiagramTestRegister with only the Busy bit set.</summary>
    public static DiagramTestRegister BusyBit { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(__BUSY_MASK); }

    /// <summary>Returns a DiagramTestRegister with the mask for the Mode field (bits 2-4).</summary>
    public static DiagramTestRegister ModeMask { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(__MODE_SHIFTED_MASK); }

    /// <summary>Returns a DiagramTestRegister with the mask for the Priority field (bits 5-6).</summary>
    public static DiagramTestRegister PriorityMask { [MethodImpl(MethodImplOptions.AggressiveInlining)] get => new(__PRIORITY_SHIFTED_MASK); }

    /// <summary>Optional description (title) for this struct.</summary>
    public static string? StructDescription => "8-bit test status register";
    ...
    {
        new("Mode", 2, 3, "byte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, "Operating mode", StructTotalBits: 8, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any, StructDescription: "8-bit test status register"),
        new("Priority", 5, 2, "byte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 8, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any, StructDescription: "8-bit test status register"),
        new("Ready", 0, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, "Ready flag", StructTotalBits: 8, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any, StructDescription: "8-bit test status register"),
        new("Error", 1, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, "Error flag", StructTotalBits: 8, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any, StructDescription: "8-bit test status register"),
        new("Busy", 7, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 8, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any, StructDescription: "8-bit test status register"),
    };

    /// <summary>Returns a new DiagramTestRegister with the Ready flag set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public DiagramTestRegister WithReady(bool value) => new(value ? (byte)(__value | __READY_MASK) : (byte)(__value & __READY_INVERTED_MASK));

    /// <summary>Returns a new DiagramTestRegister with the Error flag set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public DiagramTestRegister WithError(bool value) => new(value ? (byte)(__value | __ERROR_MASK) : (byte)(__value & __ERROR_INVERTED_MASK));

    /// <summary>Returns a new DiagramTestRegister with the Busy flag set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public DiagramTestRegister WithBusy(bool value) => new(value ? (byte)(__value | __BUSY_MASK) : (byte)(__value & __BUSY_INVERTED_MASK));

    /// <summary>Returns a new DiagramTestRegister with the Mode field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public DiagramTestRegister WithMode(byte value) => new((byte)((__value & __MODE_INVERTED_MASK) | (((byte)value << __MODE_START_BIT) & __MODE_SHIFTED_MASK)));

    /// <summary>Returns a new DiagramTestRegister with the Priority field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public DiagramTestRegister WithPriority(byte value) => new((byte)((__value & __PRIORITY_INVERTED_MASK) | (((byte)value << __PRIORITY_START_BIT) & __PRIORITY_SHIFTED_MASK)));

    /// <summary>Bitwise complement operator.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DiagramTestRegister operator ~(DiagramTestRegister a) => new((byte)~a.__value);

    /// <summary>Bitwise OR operator.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DiagramTestRegister operator |(DiagramTestRegister a, DiagramTestRegister b) => new((byte)(a.__value | b.__value));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DiagramTestRegister operator -(DiagramTestRegister a) => new(unchecked((byte)(0 - a.__value)));

    /// <summary>Addition operator.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DiagramTestRegister operator +(DiagramTestRegister a, DiagramTestRegister b) => new(unchecked((byte)(a.__value + b.__value)));

    /// <summary>Addition operator with storage type.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DiagramTestRegister operator +(DiagramTestRegister a, byte b) => new(unchecked((byte)(a.__value + b)));

    /// <summary>Addition operator with storage type.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DiagramTestRegister operator +(byte a, DiagramTestRegister b) => new(unchecked((byte)(a + b.__value)));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DiagramTestRegister operator /(DiagramTestRegister a, byte b) => new((byte)(a.__value / b));

    /// <summary>Division operator with storage type.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static DiagramTestRegister operator /(byte a, DiagramTestRegister b) => new((byte)(a / b.__value));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static int operator <<(DiagramTestRegister a, int b) => a.__value << b;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator <(DiagramTestRegister a, DiagramTestRegister b) => a.__value < b.__value;
    ...
    public override readonly bool Equals(object? obj) => obj is DiagramTestRegister other && __value == other.__value;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator byte(DiagramTestRegister value) => value.__value;
    ...
    /// <summary>Creates a new DiagramTestRegister by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(DiagramTestRegister other) => __value.CompareTo(other.__value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(DiagramTestRegister other) => __value == other.__value;
