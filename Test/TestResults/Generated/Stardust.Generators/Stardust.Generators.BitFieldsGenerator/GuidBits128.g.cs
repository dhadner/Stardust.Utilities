...
[JsonConverter(typeof(GuidBits128JsonConverter))]
public partial struct GuidBits128 : IComparable, IComparable<GuidBits128>, IEquatable<GuidBits128>,
                             IFormattable, ISpanFormattable, IParsable<GuidBits128>, ISpanParsable<GuidBits128>
{
    ...
    public static GuidBits128 Default => default;
    ...
    public GuidBits128(ulong lower, ulong upper)
    {
        __w0 = lower;
        __w1 = upper;
    }

    /// <summary>Creates a new GuidBits128 from a ulong value (zero-extended).</summary>
    public GuidBits128(ulong value) : this(value, 0UL) { }

    /// <summary>Creates a new GuidBits128 from an int value. Negative values are sign-extended
    /// to all 128 bits (e.g., -1 sets all bits to 1).</summary>
    public GuidBits128(int value)
    {
    ...
    /// <summary>Returns a GuidBits128 with the mask for the Low field (bits 0-63).</summary>
    public static GuidBits128 LowMask => new(0xFFFFFFFFFFFFFFFFUL, 0UL);

    /// <summary>Returns a GuidBits128 with the mask for the High field (bits 64-127).</summary>
    public static GuidBits128 HighMask => new(0UL, 0xFFFFFFFFFFFFFFFFUL);

    /// <summary>Returns a new GuidBits128 with the Low field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GuidBits128 WithLow(ulong value) { var copy = this; copy.Low = value; return copy; }

    /// <summary>Returns a new GuidBits128 with the High field set to the specified value.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public GuidBits128 WithHigh(ulong value) { var copy = this; copy.High = value; return copy; }
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GuidBits128 operator ~(GuidBits128 a) => new(~a.__w0, ~a.__w1);

    /// <summary>Bitwise OR operator.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GuidBits128 operator |(GuidBits128 a, GuidBits128 b) => new(a.__w0 | b.__w0, a.__w1 | b.__w1);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GuidBits128 operator &(GuidBits128 a, ulong b) => new(a.__w0 & b, 0UL);

    /// <summary>Unary plus operator.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GuidBits128 operator +(GuidBits128 a) => a;

    /// <summary>Unary negation operator. Returns two's complement negation.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GuidBits128 operator -(GuidBits128 a) => ~a + new GuidBits128(1UL);

    /// <summary>Addition operator with carry propagation.</summary>
    public static GuidBits128 operator +(GuidBits128 a, GuidBits128 b)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GuidBits128 operator +(GuidBits128 a, ulong b) => a + new GuidBits128(b);
    ...
    public static GuidBits128 operator *(GuidBits128 a, GuidBits128 b) => FromBigInteger(a.ToBigInteger() * b.ToBigInteger());

    /// <summary>Multiplication operator with ulong.</summary>
    public static GuidBits128 operator *(GuidBits128 a, ulong b) => FromBigInteger(a.ToBigInteger() * b);

    /// <summary>Multiplication operator with ulong.</summary>
    public static GuidBits128 operator *(ulong a, GuidBits128 b) => FromBigInteger(a * b.ToBigInteger());
    ...
    public static GuidBits128 operator <<(GuidBits128 a, int amount)
    {
        if (amount <= 0) return a;
        if (amount >= __TOTAL_BITS) return default;
        int wordShift = amount / 64;
        int bitShift = amount % 64;
        var result = default(GuidBits128);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GuidBits128 operator >>>(GuidBits128 a, int amount) => a >> amount;

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static ulong GetWord(GuidBits128 v, int index)
    {
        return index switch
        {
            0 => v.__w0,
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    private static void SetWord(ref GuidBits128 v, int index, ulong value)
    {
        switch (index)
        {
    ...
    public static bool operator <(GuidBits128 a, GuidBits128 b)
    {
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator >(GuidBits128 a, GuidBits128 b) => b < a;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool operator ==(GuidBits128 a, GuidBits128 b) => a.__w0 == b.__w0 && a.__w1 == b.__w1;
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GuidBits128(ulong value) => new(value);

    /// <summary>Implicit conversion from int.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator GuidBits128(int value) => new(value);

    /// <summary>Explicit conversion to BigInteger.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator BigInteger(GuidBits128 value) => value.ToBigInteger();

    /// <summary>Explicit conversion from BigInteger.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static explicit operator GuidBits128(BigInteger value) => FromBigInteger(value);

    /// <summary>Implicit conversion to UInt128.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static implicit operator UInt128(GuidBits128 value) => ((UInt128)value.__w1 << 64) | value.__w0;
    ...
    /// <summary>Creates a GuidBits128 from a BigInteger (truncated to 128 bits).</summary>
    public static GuidBits128 FromBigInteger(BigInteger value)
    {
    ...
    /// <summary>Creates a new GuidBits128 from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    /// <exception cref="ArgumentException">The span is too short.</exception>
    public GuidBits128(ReadOnlySpan<byte> bytes)
    {
    ...
    /// <summary>Creates a new GuidBits128 by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    /// <returns>The deserialized GuidBits128.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GuidBits128 ReadFrom(ReadOnlySpan<byte> bytes) => new(bytes);
    ...
    /// <summary>Parses a string into a GuidBits128. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    public static GuidBits128 Parse(string s, IFormatProvider? provider)
    {
    ...
    /// <summary>Tries to parse a string into a GuidBits128.</summary>
    public static bool TryParse(string? s, IFormatProvider? provider, out GuidBits128 result)
    {
    ...
    /// <summary>Parses a span of characters into a GuidBits128.</summary>
    public static GuidBits128 Parse(ReadOnlySpan<char> s, IFormatProvider? provider) => Parse(s.ToString(), provider);

    /// <summary>Tries to parse a span of characters into a GuidBits128.</summary>
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out GuidBits128 result) => TryParse(s.ToString(), provider, out result);

    /// <summary>Parses a string using invariant culture.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static GuidBits128 Parse(string s) => Parse(s, CultureInfo.InvariantCulture);
    ...
    public int CompareTo(object? obj)
    {
        ...
        throw new ArgumentException("Object must be of type GuidBits128", nameof(obj));
    }
    ...
    {
        /// <summary>Reads a GuidBits128 from a JSON string.</summary>
        public override GuidBits128 Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var s = reader.GetString();
            return s is null ? default : GuidBits128.Parse(s);
        }

        /// <summary>Writes a GuidBits128 to JSON as a hex string.</summary>
        public override void Write(Utf8JsonWriter writer, GuidBits128 value, JsonSerializerOptions options)
        {
