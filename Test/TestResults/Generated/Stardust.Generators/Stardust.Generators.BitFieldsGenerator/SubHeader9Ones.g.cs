                             ...
                             IFormattable, ISpanFormattable, IParsable<SubHeader9Ones>, ISpanParsable<SubHeader9Ones>
{
    ...
    public static SubHeader9Ones Default => default;
    ...
    public static SubHeader9Ones TypeCodeMask => new(__TYPE_CODE_MASK);

    /// <summary>Returns a SubHeader9Ones with the mask for the Flags field (bits 4-8).</summary>
    public static SubHeader9Ones FlagsMask => new(__FLAGS_SHIFTED_MASK);
