                             ...
                             IFormattable, ISpanFormattable, IParsable<SubHeader9Ones>, ISpanParsable<SubHeader9Ones>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)] private ushort __GetNormalizedValue() => (ushort)(__value | __NORMALIZATION_OR_MASK);
    ...
    public override bool Equals(object? obj) => obj is SubHeader9Ones other && __GetNormalizedValue() == other.__GetNormalizedValue();
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public int CompareTo(SubHeader9Ones other) => __GetNormalizedValue().CompareTo(other.__GetNormalizedValue());
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public bool Equals(SubHeader9Ones other) => __GetNormalizedValue() == other.__GetNormalizedValue();
