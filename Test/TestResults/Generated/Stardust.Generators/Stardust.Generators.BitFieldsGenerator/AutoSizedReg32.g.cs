...
[JsonConverter(typeof(AutoSizedReg32JsonConverter))]
                             ...
                             IFormattable, ISpanFormattable, IParsable<AutoSizedReg32>, ISpanParsable<AutoSizedReg32>
{
    ...
    {
        new("Address", 0, 24, "uint", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 30, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        new("Command", 24, 4, "byte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 30, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        new("Enable", 28, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 30, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
        new("Interrupt", 29, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 30, FieldMustBe: MustBe.Any, StructUndefinedMustBe: UndefinedBitsMustBe.Any),
    };
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AutoSizedReg32 operator +(AutoSizedReg32 a) => a;
    ...
    public override readonly bool Equals(object? obj) => obj is AutoSizedReg32 other && __value == other.__value;
    ...
    /// <summary>Creates a new AutoSizedReg32 from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    /// <exception cref="ArgumentException">The span is too short.</exception>
    public AutoSizedReg32(ReadOnlySpan<byte> bytes)
    {
        if (bytes.Length < SIZE_IN_BYTES)
            throw new ArgumentException($"Span must contain at least {SIZE_IN_BYTES} bytes.", nameof(bytes));
        this = new AutoSizedReg32(BinaryPrimitives.ReadUInt32LittleEndian(bytes));
    }

    /// <summary>Creates a new AutoSizedReg32 by reading <see cref="SIZE_IN_BYTES"/> bytes from a little-endian byte span.</summary>
    /// <param name="bytes">The source span. Must contain at least <see cref="SIZE_IN_BYTES"/> bytes.</param>
    /// <returns>The deserialized AutoSizedReg32.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AutoSizedReg32 ReadFrom(ReadOnlySpan<byte> bytes) => new(bytes);
    ...
    /// <summary>Parses a string into a AutoSizedReg32. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <returns>The parsed AutoSizedReg32 value.</returns>
    /// <exception cref="ArgumentNullException">s is null.</exception>
    public static AutoSizedReg32 Parse(string s, IFormatProvider? provider)
    {
    ...
    /// <summary>Tries to parse a string into a AutoSizedReg32. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    public static bool TryParse(string? s, IFormatProvider? provider, out AutoSizedReg32 result)
    {
    ...
    /// <summary>Parses a span of characters into a AutoSizedReg32. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The span of characters to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <returns>The parsed AutoSizedReg32 value.</returns>
    public static AutoSizedReg32 Parse(ReadOnlySpan<char> s, IFormatProvider? provider)
    {
        if (IsBinaryPrefix(s))
    ...
    /// <summary>Tries to parse a span of characters into a AutoSizedReg32. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The span of characters to parse.</param>
    /// <param name="provider">An object that provides culture-specific formatting information.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    public static bool TryParse(ReadOnlySpan<char> s, IFormatProvider? provider, out AutoSizedReg32 result)
    {
        if (IsBinaryPrefix(s))
        {
    ...
    /// <summary>Parses a string into a AutoSizedReg32 using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <returns>The parsed AutoSizedReg32 value.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static AutoSizedReg32 Parse(string s) => Parse(s, CultureInfo.InvariantCulture);

    /// <summary>Tries to parse a string into a AutoSizedReg32 using invariant culture. Supports decimal, hex (0x prefix), and binary (0b prefix) formats with optional underscores.</summary>
    /// <param name="s">The string to parse.</param>
    /// <param name="result">When this method returns, contains the parsed value if successful.</param>
    /// <returns>true if parsing succeeded; otherwise, false.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static bool TryParse(string? s, out AutoSizedReg32 result) => TryParse(s, CultureInfo.InvariantCulture, out result);
    ...
    /// <exception cref="ArgumentException">obj is not a AutoSizedReg32.</exception>
    public readonly int CompareTo(object? obj)
    {
        if (obj is null) return 1;
        if (obj is AutoSizedReg32 other) return CompareTo(other);
        throw new ArgumentException("Object must be of type AutoSizedReg32", nameof(obj));
    }

    /// <summary>Compares this instance to another AutoSizedReg32 and returns an integer indicating their relative order.</summary>
    /// <param name="other">A AutoSizedReg32 to compare.</param>
    /// <returns>A value indicating the relative order of the instances being compared.</returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly int CompareTo(AutoSizedReg32 other) => __value.CompareTo(other.__value);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public readonly bool Equals(AutoSizedReg32 other) => __value == other.__value;
    ...
    {
        /// <summary>Reads a AutoSizedReg32 from a JSON string.</summary>
        public override AutoSizedReg32 Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var s = reader.GetString();
            return s is null ? default : AutoSizedReg32.Parse(s);
        }

        /// <summary>Writes a AutoSizedReg32 to JSON as a string.</summary>
        public override void Write(Utf8JsonWriter writer, AutoSizedReg32 value, JsonSerializerOptions options)
        {
