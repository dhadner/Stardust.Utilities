...
public partial record struct TcpHeaderView
{
    ...
    {
        new("SourcePort", 0, 16, "ushort", false, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("DestinationPort", 16, 16, "ushort", false, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("SequenceNumber", 32, 32, "uint", false, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("AcknowledgmentNumber", 64, 32, "uint", false, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("DataOffset", 96, 4, "byte", false, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("Reserved", 100, 3, "byte", false, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("WindowSize", 112, 16, "ushort", false, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("Checksum", 128, 16, "ushort", false, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("UrgentPointer", 144, 16, "ushort", false, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("NS", 103, 1, "bool", true, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("CWR", 104, 1, "bool", true, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("ECE", 105, 1, "bool", true, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("URG", 106, 1, "bool", true, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("ACK", 107, 1, "bool", true, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("PSH", 108, 1, "bool", true, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("RST", 109, 1, "bool", true, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("SYN", 110, 1, "bool", true, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
        new("FIN", 111, 1, "bool", true, ByteOrder.BigEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 160, FieldMustBe: 0),
    };

    private sealed class TcpHeaderViewJsonConverter : JsonConverter<TcpHeaderView>
    {
        /// <summary>Reads a TcpHeaderView from a JSON hex string.</summary>
        public override TcpHeaderView Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var s = reader.GetString();
            if (s is null) return new TcpHeaderView(new byte[SIZE_IN_BYTES]);
            ...
            return new TcpHeaderView(bytes);
        }
