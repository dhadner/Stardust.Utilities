...
{
    [JsonConverter(typeof(MultiTypeBigEndianViewJsonConverter))]
    public partial record struct MultiTypeBigEndianView
    {
        ...
        public MultiTypeBigEndianView(Memory<byte> data)
        {
        ...
        public MultiTypeBigEndianView(byte[] data) : this(data.AsMemory()) { }

        /// <summary>Creates a view over a portion of the specified byte array.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public MultiTypeBigEndianView(byte[] data, int offset) : this(data.AsMemory(offset)) { }

        /// <summary>Creates a sub-view at a bit offset within the specified memory buffer (used by nested views).</summary>
        internal MultiTypeBigEndianView(Memory<byte> data, int bitOffset)
        {
            _data = data;
        ...
        public partial short ShortField
        {
            ...
            get
            {
                ...
                if (_bitOffset == 0)
                {
                    return (short)(BinaryPrimitives.ReadUInt16BigEndian(s.Slice(2)) & 0xFFFF);
                }
        ...
        public partial int IntField
        {
            ...
            get
            {
                ...
                if (_bitOffset == 0)
                {
                    return (int)(BinaryPrimitives.ReadUInt32BigEndian(s.Slice(8)) & 0xFFFFFFFFU);
                }
                int ep = 64 + _bitOffset;
                int bi = ep >> 3;
                int endInWindow = (ep + 31) - bi * 8;
                int sh = 64 - 1 - endInWindow;
                return (int)((BinaryPrimitives.ReadUInt64BigEndian(s.Slice(bi)) >> sh) & 0xFFFFFFFFUL);
            }
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set
            {
        ...
        public partial ulong ULongField
        {
            ...
            get
            {
                ...
                if (_bitOffset == 0)
                {
                    return (ulong)(BinaryPrimitives.ReadUInt64BigEndian(s.Slice(12)) & 0xFFFFFFFFFFFFFFFFUL);
                }
        ...
        public partial long LongField
        {
            ...
            get
            {
                ...
                if (_bitOffset == 0)
                {
                    return (long)(BinaryPrimitives.ReadUInt64BigEndian(s.Slice(20)) & 0xFFFFFFFFFFFFFFFFUL);
                }
                int ep = 160 + _bitOffset;
                int bi = ep >> 3;
                int endInWindow = (ep + 63) - bi * 8;
                int sh = 64 - 1 - endInWindow;
                return (long)((BinaryPrimitives.ReadUInt64BigEndian(s.Slice(bi)) >> sh) & 0xFFFFFFFFFFFFFFFFUL);
            }
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set
            {
        ...
        private sealed class MultiTypeBigEndianViewJsonConverter : JsonConverter<MultiTypeBigEndianView>
        {
            /// <summary>Reads a MultiTypeBigEndianView from a JSON hex string.</summary>
            public override MultiTypeBigEndianView Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new MultiTypeBigEndianView(new byte[SIZE_IN_BYTES]);
                ...
                return new MultiTypeBigEndianView(bytes);
            }

            /// <summary>Writes a MultiTypeBigEndianView to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, MultiTypeBigEndianView value, JsonSerializerOptions options)
            {
