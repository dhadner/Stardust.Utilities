...
{
    [JsonConverter(typeof(UnifiedLeViewJsonConverter))]
    public partial record struct UnifiedLeView
    {
        ...
        public UnifiedLeView(Memory<byte> data)
        {
        ...
        private sealed class UnifiedLeViewJsonConverter : JsonConverter<UnifiedLeView>
        {
            /// <summary>Reads a UnifiedLeView from a JSON hex string.</summary>
            public override UnifiedLeView Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new UnifiedLeView(new byte[SIZE_IN_BYTES]);
                ...
                return new UnifiedLeView(bytes);
            }

            /// <summary>Writes a UnifiedLeView to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, UnifiedLeView value, JsonSerializerOptions options)
            {
