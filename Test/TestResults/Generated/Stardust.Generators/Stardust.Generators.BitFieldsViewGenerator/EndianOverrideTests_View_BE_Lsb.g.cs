...
{
    [JsonConverter(typeof(View_BE_LsbJsonConverter))]
    public partial record struct View_BE_Lsb
    {
        ...
        public View_BE_Lsb(Memory<byte> data)
        {
        ...
        {
            new("NativeU16", 0, 16, "ushort", false, ByteOrder.BigEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 128, FieldMustBe: 0),
            new("LeU32", 16, 32, "Stardust.Utilities.UInt32Le", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 128, FieldMustBe: 0),
            new("LeS16", 48, 16, "Stardust.Utilities.Int16Le", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 128, FieldMustBe: 0),
            new("LeU64", 64, 64, "Stardust.Utilities.UInt64Le", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 128, FieldMustBe: 0),
        };

        private sealed class View_BE_LsbJsonConverter : JsonConverter<View_BE_Lsb>
        {
            /// <summary>Reads a View_BE_Lsb from a JSON hex string.</summary>
            public override View_BE_Lsb Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new View_BE_Lsb(new byte[SIZE_IN_BYTES]);
                ...
                return new View_BE_Lsb(bytes);
            }

            /// <summary>Writes a View_BE_Lsb to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, View_BE_Lsb value, JsonSerializerOptions options)
            {
