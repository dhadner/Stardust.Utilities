...
{
    [JsonConverter(typeof(UnifiedBeFlagsViewJsonConverter))]
    public partial record struct UnifiedBeFlagsView
    {
        ...
        public UnifiedBeFlagsView(Memory<byte> data)
        {
        ...
        public UnifiedBeFlagsView(byte[] data) : this(data.AsMemory()) { }

        /// <summary>Creates a view over a portion of the specified byte array.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UnifiedBeFlagsView(byte[] data, int offset) : this(data.AsMemory(offset)) { }

        /// <summary>Creates a sub-view at a bit offset within the specified memory buffer (used by nested views).</summary>
        internal UnifiedBeFlagsView(Memory<byte> data, int bitOffset)
        {
            _data = data;
        ...
        private sealed class UnifiedBeFlagsViewJsonConverter : JsonConverter<UnifiedBeFlagsView>
        {
            /// <summary>Reads a UnifiedBeFlagsView from a JSON hex string.</summary>
            public override UnifiedBeFlagsView Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new UnifiedBeFlagsView(new byte[SIZE_IN_BYTES]);
                ...
                return new UnifiedBeFlagsView(bytes);
            }

            /// <summary>Writes a UnifiedBeFlagsView to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, UnifiedBeFlagsView value, JsonSerializerOptions options)
            {
