...
public partial record struct UdpHeaderView
{
    ...
    public UdpHeaderView(Memory<byte> data)
    {
    ...
    public UdpHeaderView(byte[] data) : this(data.AsMemory()) { }

    /// <summary>Creates a view over a portion of the specified byte array.</summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public UdpHeaderView(byte[] data, int offset) : this(data.AsMemory(offset)) { }
    ...
    private sealed class UdpHeaderViewJsonConverter : JsonConverter<UdpHeaderView>
    {
        /// <summary>Reads a UdpHeaderView from a JSON hex string.</summary>
        public override UdpHeaderView Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var s = reader.GetString();
            if (s is null) return new UdpHeaderView(new byte[SIZE_IN_BYTES]);
            ...
            return new UdpHeaderView(bytes);
        }
