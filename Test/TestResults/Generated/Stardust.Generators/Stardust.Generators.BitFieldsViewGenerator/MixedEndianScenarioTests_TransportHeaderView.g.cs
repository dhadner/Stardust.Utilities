    ...
    public partial record struct TransportHeaderView
    {
        ...
        public partial uint PayloadLength
        {
            ...
            get
            {
                ...
                if (_bitOffset == 0)
                {
                    return (uint)(BinaryPrimitives.ReadUInt32BigEndian(s.Slice(2)) & 0xFFFFFFFFU);
                }
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => new global::Stardust.Utilities.Tests.MixedEndianScenarioTests.FileBlobView(_data.Slice(8));
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set { value.Data.Span.Slice(0, global::Stardust.Utilities.Tests.MixedEndianScenarioTests.FileBlobView.SIZE_IN_BYTES).CopyTo(_data.Span.Slice(8)); }
        }
