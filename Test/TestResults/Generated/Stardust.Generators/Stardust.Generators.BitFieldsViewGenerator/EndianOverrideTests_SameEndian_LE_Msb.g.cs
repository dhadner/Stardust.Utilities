...
{
    [JsonConverter(typeof(SameEndian_LE_MsbJsonConverter))]
    public partial record struct SameEndian_LE_Msb
    {
        ...
        {
            new("NativeU16", 0, 16, "ushort", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 32, FieldMustBe: 0),
            new("ExplicitU16", 16, 16, "Stardust.Utilities.UInt16Le", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsMsb, StructTotalBits: 32, FieldMustBe: 0),
        };

        private sealed class SameEndian_LE_MsbJsonConverter : JsonConverter<SameEndian_LE_Msb>
        {
            /// <summary>Reads a SameEndian_LE_Msb from a JSON hex string.</summary>
            public override SameEndian_LE_Msb Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new SameEndian_LE_Msb(new byte[SIZE_IN_BYTES]);
                ...
                return new SameEndian_LE_Msb(bytes);
            }

            /// <summary>Writes a SameEndian_LE_Msb to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, SameEndian_LE_Msb value, JsonSerializerOptions options)
            {
