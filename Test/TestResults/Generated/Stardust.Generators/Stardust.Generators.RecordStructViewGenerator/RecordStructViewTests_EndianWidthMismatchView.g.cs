...
{
    [JsonConverter(typeof(EndianWidthMismatchViewJsonConverter))]
    public partial record struct EndianWidthMismatchView
    {
        ...
        public partial global::Stardust.Utilities.UInt32Be WideTypeNarrowField
        {
            ...
            get
            {
                ...
                if (__bitOffset == 0)
                {
                    return (global::Stardust.Utilities.UInt32Be)(uint)BinaryPrimitives.ReadUInt16BigEndian(s.Slice(0));
                }
            ...
            set
            {
                ...
                {
                    var slice = s.Slice(0);
                    BinaryPrimitives.WriteUInt16BigEndian(slice, (ushort)(uint)value);
                }
                else
                {
                    int ep = 0 + __bitOffset;
        ...
        public partial ushort Neighbor
        {
            ...
            get
            {
                ...
                if (__bitOffset == 0)
                {
                    return (ushort)BinaryPrimitives.ReadUInt16LittleEndian(s.Slice(2));
                }
        ...
        {
            new("WideTypeNarrowField", 0, 16, "Stardust.Utilities.UInt32Be", false, ByteOrder.BigEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 32, FieldMustBe: 0),
            new("Neighbor", 16, 16, "ushort", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 32, FieldMustBe: 0),
        };

        private sealed class EndianWidthMismatchViewJsonConverter : JsonConverter<EndianWidthMismatchView>
        {
            /// <summary>Reads a EndianWidthMismatchView from a JSON hex string.</summary>
            public override EndianWidthMismatchView Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new EndianWidthMismatchView(new byte[SIZE_IN_BYTES]);
                ...
                return new EndianWidthMismatchView(bytes);
            }

            /// <summary>Writes a EndianWidthMismatchView to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, EndianWidthMismatchView value, JsonSerializerOptions options)
            {
