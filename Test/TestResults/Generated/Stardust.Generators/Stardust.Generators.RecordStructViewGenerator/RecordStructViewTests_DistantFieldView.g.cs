...
{
    [JsonConverter(typeof(DistantFieldViewJsonConverter))]
    public partial record struct DistantFieldView
    {
        ...
        public const int SIZE_IN_BYTES = 102;
        public const int BIT_WIDTH = 816;
        ...
        public partial ushort Distant
        {
            ...
            get
            {
                ...
                if (__bitOffset == 0)
                {
                    return (ushort)BinaryPrimitives.ReadUInt16BigEndian(s.Slice(100));
                }
                int ep = 800 + __bitOffset;
                int bi = ep >> 3;
        ...
        private sealed class DistantFieldViewJsonConverter : JsonConverter<DistantFieldView>
        {
            /// <summary>Reads a DistantFieldView from a JSON hex string.</summary>
            public override DistantFieldView Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new DistantFieldView(new byte[SIZE_IN_BYTES]);
                ...
                return new DistantFieldView(bytes);
            }

            /// <summary>Writes a DistantFieldView to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, DistantFieldView value, JsonSerializerOptions options)
            {
