...
{
    [JsonConverter(typeof(LsbByteViewJsonConverter))]
    public partial record struct LsbByteView
    {
        ...
        {
            new("Middle", 1, 4, "byte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 8, FieldMustBe: 0),
            new("LsbFlag", 0, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 8, FieldMustBe: 0),
            new("MsbFlag", 7, 1, "bool", true, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 8, FieldMustBe: 0),
        };

        private sealed class LsbByteViewJsonConverter : JsonConverter<LsbByteView>
        {
            /// <summary>Reads a LsbByteView from a JSON hex string.</summary>
            public override LsbByteView Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new LsbByteView(new byte[SIZE_IN_BYTES]);
                ...
                return new LsbByteView(bytes);
            }

            /// <summary>Writes a LsbByteView to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, LsbByteView value, JsonSerializerOptions options)
            {
