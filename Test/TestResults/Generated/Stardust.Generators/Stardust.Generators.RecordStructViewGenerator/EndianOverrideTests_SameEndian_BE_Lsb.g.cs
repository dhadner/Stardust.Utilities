...
{
    [JsonConverter(typeof(SameEndian_BE_LsbJsonConverter))]
    public partial record struct SameEndian_BE_Lsb
    {
        ...
        public SameEndian_BE_Lsb(Memory<byte> data)
        {
        ...
        public SameEndian_BE_Lsb(byte[] data) : this(data.AsMemory()) { }

        /// <summary>Creates a view over a portion of the specified byte array.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SameEndian_BE_Lsb(byte[] data, int offset) : this(data.AsMemory(offset)) { }

        /// <summary>Creates a sub-view at a bit offset within the specified memory buffer (used by nested views).</summary>
        internal SameEndian_BE_Lsb(Memory<byte> data, int bitOffset)
        {
            _data = data;
        ...
        {
            new("NativeU16", 0, 16, "ushort", false, ByteOrder.BigEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 32, FieldMustBe: 0),
            new("ExplicitU16", 16, 16, "Stardust.Utilities.UInt16Be", false, ByteOrder.BigEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 32, FieldMustBe: 0),
        };

        private sealed class SameEndian_BE_LsbJsonConverter : JsonConverter<SameEndian_BE_Lsb>
        {
            /// <summary>Reads a SameEndian_BE_Lsb from a JSON hex string.</summary>
            public override SameEndian_BE_Lsb Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new SameEndian_BE_Lsb(new byte[SIZE_IN_BYTES]);
                ...
                return new SameEndian_BE_Lsb(bytes);
            }

            /// <summary>Writes a SameEndian_BE_Lsb to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, SameEndian_BE_Lsb value, JsonSerializerOptions options)
            {
