...
{
    [JsonConverter(typeof(SameEndian_BE_MsbJsonConverter))]
    public partial record struct SameEndian_BE_Msb
    {
        ...
        public SameEndian_BE_Msb(Memory<byte> data)
        {
        ...
        public SameEndian_BE_Msb(byte[] data) : this(data.AsMemory()) { }

        /// <summary>Creates a view over a portion of the specified byte array.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public SameEndian_BE_Msb(byte[] data, int offset) : this(data.AsMemory(offset)) { }

        /// <summary>Creates a sub-view at a bit offset within the specified memory buffer (used by nested views).</summary>
        internal SameEndian_BE_Msb(Memory<byte> data, int bitOffset)
        {
            _data = data;
        ...
        private sealed class SameEndian_BE_MsbJsonConverter : JsonConverter<SameEndian_BE_Msb>
        {
            /// <summary>Reads a SameEndian_BE_Msb from a JSON hex string.</summary>
            public override SameEndian_BE_Msb Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new SameEndian_BE_Msb(new byte[SIZE_IN_BYTES]);
                ...
                return new SameEndian_BE_Msb(bytes);
            }

            /// <summary>Writes a SameEndian_BE_Msb to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, SameEndian_BE_Msb value, JsonSerializerOptions options)
            {
