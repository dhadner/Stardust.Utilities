...
public partial class MixedEndianScenarioTests
{
    ...
    public partial record struct FileBlobView
    {
        ...
        private sealed class FileBlobViewJsonConverter : JsonConverter<FileBlobView>
        {
            /// <summary>Reads a FileBlobView from a JSON hex string.</summary>
            public override FileBlobView Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new FileBlobView(new byte[SIZE_IN_BYTES]);
