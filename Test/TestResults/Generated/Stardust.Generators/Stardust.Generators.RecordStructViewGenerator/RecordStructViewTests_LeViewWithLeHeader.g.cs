...
{
    [JsonConverter(typeof(LeViewWithLeHeaderJsonConverter))]
    public partial record struct LeViewWithLeHeader
    {
        ...
        {
            new("Header", 0, 16, "Stardust.Utilities.Tests.ProtocolHeader16", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 24, FieldMustBe: 0),
            new("Tag", 16, 8, "byte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 24, FieldMustBe: 0),
        };

        private sealed class LeViewWithLeHeaderJsonConverter : JsonConverter<LeViewWithLeHeader>
        {
            /// <summary>Reads a LeViewWithLeHeader from a JSON hex string.</summary>
            public override LeViewWithLeHeader Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new LeViewWithLeHeader(new byte[SIZE_IN_BYTES]);
                ...
                return new LeViewWithLeHeader(bytes);
            }

            /// <summary>Writes a LeViewWithLeHeader to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, LeViewWithLeHeader value, JsonSerializerOptions options)
            {
