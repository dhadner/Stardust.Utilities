...
{
    [JsonConverter(typeof(InnerViewJsonConverter))]
    public partial record struct InnerView
    {
        ...
        private sealed class InnerViewJsonConverter : JsonConverter<InnerView>
        {
            /// <summary>Reads a InnerView from a JSON hex string.</summary>
            public override InnerView Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new InnerView(new byte[SIZE_IN_BYTES]);
                ...
                return new InnerView(bytes);
            }

            /// <summary>Writes a InnerView to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, InnerView value, JsonSerializerOptions options)
            {
