...
{
    [JsonConverter(typeof(OuterByteAlignedJsonConverter))]
    public partial record struct OuterByteAligned
    {
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => new global::Stardust.Utilities.Tests.RecordStructViewTests.InnerView(__data.Slice(2));
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set { value.Data.Span.Slice(0, global::Stardust.Utilities.Tests.RecordStructViewTests.InnerView.SIZE_IN_BYTES).CopyTo(__data.Span.Slice(2)); }
        }

        /// <summary>Metadata for every field and flag declared on this view, in declaration order.</summary>
        public static ReadOnlySpan<BitFieldInfo> Fields => new BitFieldInfo[]
        {
            new("Header", 0, 8, "byte", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 24, FieldMustBe: 0),
        };

        private sealed class OuterByteAlignedJsonConverter : JsonConverter<OuterByteAligned>
        {
            /// <summary>Reads a OuterByteAligned from a JSON hex string.</summary>
            public override OuterByteAligned Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new OuterByteAligned(new byte[SIZE_IN_BYTES]);
                ...
                return new OuterByteAligned(bytes);
            }

            /// <summary>Writes a OuterByteAligned to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, OuterByteAligned value, JsonSerializerOptions options)
            {
