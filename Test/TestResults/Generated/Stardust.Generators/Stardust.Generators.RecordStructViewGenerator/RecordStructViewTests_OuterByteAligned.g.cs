...
public partial class RecordStructViewTests
{
    ...
    public partial record struct OuterByteAligned
    {
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => new global::Stardust.Utilities.Tests.RecordStructViewTests.InnerView(_data.Slice(2));
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set { value.Data.Span.Slice(0, global::Stardust.Utilities.Tests.RecordStructViewTests.InnerView.SIZE_IN_BYTES).CopyTo(_data.Span.Slice(2)); }
        }
