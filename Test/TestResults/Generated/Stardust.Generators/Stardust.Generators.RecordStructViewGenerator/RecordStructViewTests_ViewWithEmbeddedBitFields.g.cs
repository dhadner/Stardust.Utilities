...
public partial class RecordStructViewTests
{
    ...
    public partial record struct ViewWithEmbeddedBitFields
    {
        ...
        public partial global::Stardust.Utilities.Tests.RecordStructViewTests.EmbeddedFlags Flags
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get
            {
                ...
                if (__bitOffset == 0)
                {
                    return (global::Stardust.Utilities.Tests.RecordStructViewTests.EmbeddedFlags)(byte)s[0];
                }
                int ep = 0 + __bitOffset;
                int bi = ep >> 3;
                int sh = ep & 7;
                return (global::Stardust.Utilities.Tests.RecordStructViewTests.EmbeddedFlags)(byte)((BinaryPrimitives.ReadUInt16LittleEndian(s.Slice(bi)) >> sh) & 0x00FF);
            }
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set
            {
        ...
        {
            new("Flags", 0, 8, "Stardust.Utilities.Tests.RecordStructViewTests.EmbeddedFlags", false, ByteOrder.LittleEndian, BitOrder.BitZeroIsLsb, StructTotalBits: 16, FieldMustBe: 0),
