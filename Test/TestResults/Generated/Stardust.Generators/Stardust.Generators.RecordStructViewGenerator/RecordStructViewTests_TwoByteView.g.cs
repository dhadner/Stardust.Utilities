...
{
    [JsonConverter(typeof(TwoByteViewJsonConverter))]
    public partial record struct TwoByteView
    {
        ...
        public TwoByteView(Memory<byte> data)
        {
        ...
        private sealed class TwoByteViewJsonConverter : JsonConverter<TwoByteView>
        {
            /// <summary>Reads a TwoByteView from a JSON hex string.</summary>
            public override TwoByteView Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new TwoByteView(new byte[SIZE_IN_BYTES]);
                ...
                return new TwoByteView(bytes);
            }

            /// <summary>Writes a TwoByteView to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, TwoByteView value, JsonSerializerOptions options)
            {
