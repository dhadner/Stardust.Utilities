...
public partial record struct DescEscapeView
{
    ...
    private sealed class DescEscapeViewJsonConverter : JsonConverter<DescEscapeView>
    {
        /// <summary>Reads a DescEscapeView from a JSON hex string.</summary>
        public override DescEscapeView Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            var s = reader.GetString();
            if (s is null) return new DescEscapeView(new byte[SIZE_IN_BYTES]);
            ...
            return new DescEscapeView(bytes);
        }
