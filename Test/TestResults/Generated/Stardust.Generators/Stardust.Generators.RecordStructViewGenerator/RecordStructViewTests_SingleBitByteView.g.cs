...
{
    [JsonConverter(typeof(SingleBitByteViewJsonConverter))]
    public partial record struct SingleBitByteView
    {
        ...
        private sealed class SingleBitByteViewJsonConverter : JsonConverter<SingleBitByteView>
        {
            /// <summary>Reads a SingleBitByteView from a JSON hex string.</summary>
            public override SingleBitByteView Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                var s = reader.GetString();
                if (s is null) return new SingleBitByteView(new byte[SIZE_IN_BYTES]);
                ...
                return new SingleBitByteView(bytes);
            }

            /// <summary>Writes a SingleBitByteView to JSON as a hex string.</summary>
            public override void Write(Utf8JsonWriter writer, SingleBitByteView value, JsonSerializerOptions options)
            {
