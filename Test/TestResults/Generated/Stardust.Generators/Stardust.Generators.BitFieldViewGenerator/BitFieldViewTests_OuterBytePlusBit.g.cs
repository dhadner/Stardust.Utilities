...
public partial class BitFieldViewTests
{
    public partial record struct OuterBytePlusBit
    {
        ...
        public partial global::Stardust.Utilities.Tests.BitFieldViewTests.InnerView Inner
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => new global::Stardust.Utilities.Tests.BitFieldViewTests.InnerView(_data.Slice(1), 4);
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set
            {
                var src = value.Data.Span;
                var dst = new global::Stardust.Utilities.Tests.BitFieldViewTests.InnerView(_data.Slice(1), 4);
                ...
                src.Slice(0, global::Stardust.Utilities.Tests.BitFieldViewTests.InnerView.SizeInBytes).CopyTo(_data.Span.Slice(1));
            }
        }
