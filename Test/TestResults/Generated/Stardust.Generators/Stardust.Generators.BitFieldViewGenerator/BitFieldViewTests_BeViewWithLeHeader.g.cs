    ...
    public partial record struct BeViewWithLeHeader
    {
        ...
        public partial ProtocolHeader16 Header
        {
            ...
            get
            {
                ...
                if (_bitOffset == 0)
                {
                    return (ProtocolHeader16)(BinaryPrimitives.ReadUInt16BigEndian(s.Slice(0)) & 0xFFFF);
                }
                int ep = 0 + _bitOffset;
                int bi = ep >> 3;
                int endInWindow = (ep + 15) - bi * 8;
                int sh = 32 - 1 - endInWindow;
                return (ProtocolHeader16)((BinaryPrimitives.ReadUInt32BigEndian(s.Slice(bi)) >> sh) & 0xFFFFU);
            }
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set
            {
