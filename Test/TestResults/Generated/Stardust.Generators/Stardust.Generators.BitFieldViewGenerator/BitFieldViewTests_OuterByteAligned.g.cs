...
public partial class BitFieldViewTests
{
    public partial record struct OuterByteAligned
    {
        ...
        {
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            get => new global::Stardust.Utilities.Tests.BitFieldViewTests.InnerView(_data.Slice(2));
            [MethodImpl(MethodImplOptions.AggressiveInlining)]
            set { value.Data.Span.Slice(0, global::Stardust.Utilities.Tests.BitFieldViewTests.InnerView.SizeInBytes).CopyTo(_data.Span.Slice(2)); }
        }
