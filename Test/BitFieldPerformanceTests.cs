...
/// <summary>
/// Generated struct using [BitFields] attribute.
/// The source generator creates inline constant bit manipulation.
/// </summary>
[BitFields]
public partial struct PerfTestGeneratedRegister
{
    public byte Value;
    ...
    [BitField(2, 3)] public partial byte Mode { get; set; }  // Bits 2-4
    [BitField(5, 2)] public partial byte Priority { get; set; }  // Bits 5-6
}
...
/// </summary>
public struct PerfTestHandCodedRegister
{
    public byte Value;
...
public class BitFieldPerformanceTests
{
    ...
    public void BitFlag_Get_Performance()
    {
        ...
        // Test generated code
        var generatedReg = new PerfTestGeneratedRegister { Value = 0xAA };
        ...
        // Test hand-coded
        var handCodedReg = new PerfTestHandCodedRegister { Value = 0xAA };
        sw.Restart();
        int trueCount2 = 0;
        for (int i = 0; i < ITERATIONS; i++)
        {
    ...
    public void BitFlag_Set_Performance()
    {
        ...
        // Test generated code
        var generatedReg = new PerfTestGeneratedRegister();
        var sw = Stopwatch.StartNew();
        for (int i = 0; i < ITERATIONS; i++)
        {
        ...
        // Test hand-coded
        var handCodedReg = new PerfTestHandCodedRegister();
        sw.Restart();
        for (int i = 0; i < ITERATIONS; i++)
        {
    ...
    public void BitField_Get_Performance()
    {
        ...
        // Test generated code
        var generatedReg = new PerfTestGeneratedRegister { Value = 0xFF };
        var sw = Stopwatch.StartNew();
        int sum = 0;
        for (int i = 0; i < ITERATIONS; i++)
        {
        ...
        // Test hand-coded
        var handCodedReg = new PerfTestHandCodedRegister { Value = 0xFF };
        sw.Restart();
        int sum2 = 0;
        for (int i = 0; i < ITERATIONS; i++)
        {
    ...
    public void FullSuite_Performance_Summary()
    {
        ...
        for (int run = 0; run < RUNS; run++)
        {
            ...
            {
                var reg = new PerfTestGeneratedRegister { Value = 0xAA };
                int c = 0;
                for (int i = 0; i < ITERATIONS; i++)
                {
                    if (reg.Ready) c++;
            ...
            {
                var reg = new PerfTestHandCodedRegister { Value = 0xAA };
                int c = 0;
                for (int i = 0; i < ITERATIONS; i++)
                {
                    if (reg.Ready) c++;
            ...
            {
                var reg = new PerfTestGeneratedRegister();
                for (int i = 0; i < ITERATIONS; i++)
                {
                    reg.Ready = true;
                    reg.Error = false;
            ...
            (gen, hand) = RunSingleTest(() =>
            {
                var reg = new PerfTestGeneratedRegister { Value = 0xFF };
                int sum = 0;
                for (int i = 0; i < ITERATIONS; i++)
                {
                    sum += reg.Mode;
            ...
            {
                var reg = new PerfTestHandCodedRegister { Value = 0xFF };
                int sum = 0;
                for (int i = 0; i < ITERATIONS; i++)
                {
                    sum += reg.Mode;
    ...
    {
        var reg = new PerfTestGeneratedRegister { Value = 0x55 };
