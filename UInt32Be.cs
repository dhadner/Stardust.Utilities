...
namespace Stardust.Utilities
{
                              ...
                              IFormattable, ISpanFormattable, IParsable<UInt32Be>, ISpanParsable<UInt32Be>
    {
        ...
        /// <summary>
        /// Creates a big-endian 32-bit unsigned integer from a ReadOnlySpan at the given offset.
        /// </summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt32Be(ReadOnlySpan<byte> bytes, int offset, bool isBigEndian = true)
        {
        ...
        /// <summary>
        /// Creates a big-endian 32-bit unsigned integer from a byte array whose byte order is specified.
        /// </summary>
        ...
        public UInt32Be(byte[] bytes, bool isBigEndian = true) : this(new ReadOnlySpan<byte>(bytes), isBigEndian) { }

        /// <summary>
        /// Creates a big-endian 32-bit unsigned integer from a byte array at the given offset.
        /// </summary>
        ...
        /// <param name="isBigEndian">If <see langword="true"/> (default) the source is interpreted as big-endian; if <see langword="false"/> it is interpreted as little-endian and reversed during storage.</param>
        /// <exception cref="ArgumentException">If array is too short.</exception>
        public UInt32Be(byte[] bytes, int offset, bool isBigEndian = true) : this(new ReadOnlySpan<byte>(bytes), offset, isBigEndian) { }
        ...
        [Obsolete("IList<byte> overloads are deprecated. Use WriteTo(uint, Span<byte>) instead.")]
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UInt32Be ReadFrom(ReadOnlySpan<byte> source, int offset = 0, bool isBigEndian = true) => new(source, offset, isBigEndian);

        /// <summary>
        /// Reads a <see cref="UInt32Be"/> from a byte array in the specified byte order.
        /// </summary>
        ...
        /// <returns>The parsed value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UInt32Be ReadFrom(byte[] source, int offset = 0, bool isBigEndian = true) => new(new ReadOnlySpan<byte>(source), offset, isBigEndian);
