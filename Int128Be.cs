...
namespace Stardust.Utilities
{
                              ...
                              IFormattable, ISpanFormattable, IParsable<Int128Be>, ISpanParsable<Int128Be>
    {
        ...
        /// <summary>
        /// Creates a big-endian 128-bit signed integer from a ReadOnlySpan whose byte order is specified.
        /// </summary>
        /// <param name="bytes">Source span (must have at least 16 bytes).</param>
        ...
        /// <exception cref="ArgumentException">If span is too short.</exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Int128Be(ReadOnlySpan<byte> bytes, bool isBigEndian = true)
        {
            if (bytes.Length < 16)
            {
                throw new ArgumentException("Span must have at least 16 bytes", nameof(bytes));
        ...
        /// <summary>
        /// Creates a big-endian 128-bit signed integer from a ReadOnlySpan at the given offset.
        /// </summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Int128Be(ReadOnlySpan<byte> bytes, int offset, bool isBigEndian = true)
        {
        ...
        /// <summary>
        /// Creates a big-endian 128-bit signed integer from a byte array whose byte order is specified.
        /// </summary>
        ...
        public Int128Be(byte[] bytes, bool isBigEndian = true) : this(new ReadOnlySpan<byte>(bytes), isBigEndian) { }

        /// <summary>
        /// Creates a big-endian 128-bit signed integer from a byte array at the given offset.
        /// </summary>
        ...
        /// <param name="isBigEndian">If <see langword="true"/> (default) the source is interpreted as big-endian; if <see langword="false"/> it is interpreted as little-endian and reversed during storage.</param>
        /// <exception cref="ArgumentException">If array is too short.</exception>
        public Int128Be(byte[] bytes, int offset, bool isBigEndian = true) : this(new ReadOnlySpan<byte>(bytes), offset, isBigEndian) { }
        ...
        /// <summary>
        /// Reads an <see cref="Int128Be"/> from a ReadOnlySpan in the specified byte order.
        /// </summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Int128Be ReadFrom(ReadOnlySpan<byte> source, int offset = 0, bool isBigEndian = true) => new(source, offset, isBigEndian);

        /// <summary>
        /// Reads an <see cref="Int128Be"/> from a byte array in the specified byte order.
        /// </summary>
        ...
        /// <returns>The parsed value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Int128Be ReadFrom(byte[] source, int offset = 0, bool isBigEndian = true) => new(new ReadOnlySpan<byte>(source), offset, isBigEndian);
