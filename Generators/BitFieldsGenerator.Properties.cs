    ...
    private static void GenerateBitFieldProperty(StringBuilder sb, BitFieldsInfo info, BitFieldInfo field, string indent)
    {
        ...
        else
        {
            ...
            if (info.NeedsUnsignedCast)
            {
                ...
                {
                    sb.AppendLine($"{indent}    get => ({field.PropertyType})(((({info.UnsignedStorageType})Value) >> {startBitConst}) & {maskHex});");
                }
            }
            else
            {
                ...
                {
                    sb.AppendLine($"{indent}    get => ({field.PropertyType})((Value >> {startBitConst}) & {maskHex});");
                }
            }
        }
        ...
        else if (info.NeedsUnsignedCast)
        {
            ...
            {
                sb.AppendLine($"{indent}    set => Value = ({info.StorageType})(((({info.UnsignedStorageType})Value) & {invertedMaskHex}) | (((({info.UnsignedStorageType})value) << {startBitConst}) & {shiftedMaskHex}));");
            }
        }
        else
        {
            ...
            {
                sb.AppendLine($"{indent}    set => Value = ({info.StorageType})((Value & {invertedMaskHex}) | (((({info.StorageType})value) << {startBitConst}) & {shiftedMaskHex}));");
            }
        }
