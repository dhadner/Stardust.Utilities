...
{
    /// <summary>
    /// Used to support PropertyGrid editing of UInt64Le.
    /// </summary>
    public class UInt64LeTypeConverter : TypeConverter
    {
        ...
        /// <summary>
        /// Converts the given value to a UInt64Le instance.
        /// </summary>
        /// <param name="context">Context information.</param>
                                            ...
                                            CultureInfo? culture, object value)
        {
            if (value is string)
            {
                ...
                var val = UInt64Le.Parse(s, style);
                return val;
            }
                                          ...
                                          object? value, Type destinationType)
        {
            ...
            {
                return value != null ? $"{value:x16}" : null;
            }
