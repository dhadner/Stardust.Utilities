...
{
    /// <summary>
    /// Used to support PropertyGrid editing of <see cref="Int64Be"/>.
    ...
    public class Int64BeTypeConverter : TypeConverter
    {
        private static readonly StandardValuesCollection STANDARD_VALUES =
            new(new Int64Be[] { new(long.MinValue), new(0L), new(long.MaxValue) });
        ...
        /// <summary>
        /// Converts the given value to an <see cref="Int64Be"/> instance.
        /// </summary>
        /// <param name="context">Context information.</param>
        /// <param name="culture">Culture information (used for decimal parsing).</param>
        /// <param name="value">The value to convert.</param>
        /// <returns>The converted <see cref="Int64Be"/>.</returns>
        public override object? ConvertFrom(ITypeDescriptorContext? context, CultureInfo? culture, object value)
        {
            if (value is string s)
            {
                return ConverterParsing.Parse<Int64Be>(s, culture,
                    (d, p) => Int64Be.Parse(d, p),
                    h => Int64Be.Parse(h, NumberStyles.HexNumber));
            }
            if (value is long i) return new Int64Be(i);
                                          ...
                                          object? value, Type destinationType)
        {
            if (destinationType == typeof(string))
            {
                ...
                if (value is Int64Be v) return $"0x{(ulong)(long)v:x16}";
            }
            if (destinationType == typeof(long) && value is Int64Be v2) return (long)v2;
            if (destinationType == typeof(InstanceDescriptor) && value is Int64Be v3)
            {
                ConstructorInfo ctor = typeof(Int64Be).GetConstructor(new[] { typeof(long) })!;
        ...
        {
            if (value is Int64Be) return true;
            if (value is long) return true;
            if (value is string s)
            {
                return ConverterParsing.TryParse<Int64Be>(s, null,
                    (d, p) => Int64Be.Parse(d, p),
                    h => Int64Be.Parse(h, NumberStyles.HexNumber),
                    out _);
            }
