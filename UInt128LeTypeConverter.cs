...
{
    /// <summary>
    /// Used to support PropertyGrid editing of UInt128Le.
    /// </summary>
    public class UInt128LeTypeConverter : TypeConverter
    {
        ...
        /// <summary>
        /// Converts the given value to a UInt128Le instance.
        /// </summary>
        /// <param name="context">Context information.</param>
                                            ...
                                            CultureInfo? culture, object value)
        {
            if (value is string)
            {
                ...
                var val = UInt128Le.Parse(s, style);
                return val;
            }
                                          ...
                                          object? value, Type destinationType)
        {
            ...
            {
                return value != null ? $"{value:x32}" : null;
            }
