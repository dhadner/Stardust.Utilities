...
{
    /// <summary>
    /// Used to support PropertyGrid editing of UInt32Le.
    /// </summary>
    public class UInt32LeTypeConverter : TypeConverter
    {
        ...
        /// <summary>
        /// Converts the given value to a UInt32Le instance.
        /// </summary>
        /// <param name="context">Context information.</param>
                                            ...
                                            CultureInfo? culture, object value)
        {
            if (value is string)
            {
                ...
                var val = UInt32Le.Parse(s, style);
                return val;
            }
                                          ...
                                          object? value, Type destinationType)
        {
            ...
            {
                return value != null ? $"{value:x8}" : null;
            }
