...
namespace Stardust.Utilities
{
                              ...
                              IFormattable, ISpanFormattable, IParsable<UInt32Le>, ISpanParsable<UInt32Le>
    {
        ...
        /// <summary>
        /// Initializes a new <see cref="UInt32Le"/> from a read-only byte span at the given offset.
        /// </summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt32Le(ReadOnlySpan<byte> bytes, int offset, bool isBigEndian = false)
        {
        ...
        /// <summary>Initializes a new <see cref="UInt32Le"/> from a byte array whose byte order is specified.</summary>
        ...
        public UInt32Le(byte[] bytes, bool isBigEndian = false) : this(new ReadOnlySpan<byte>(bytes), isBigEndian) { }
        ...
        public UInt32Le(byte[] bytes, int offset, bool isBigEndian = false) : this(new ReadOnlySpan<byte>(bytes), offset, isBigEndian) { }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UInt32Le ReadFrom(ReadOnlySpan<byte> source, int offset = 0, bool isBigEndian = false) => new(source, offset, isBigEndian);

        /// <summary>Reads a <see cref="UInt32Le"/> from a byte array in the specified byte order.</summary>
        /// <param name="source">A byte array containing at least 4 bytes.</param>
        /// <param name="offset">The zero-based offset into <paramref name="source"/>.</param>
        /// <param name="isBigEndian">If <see langword="false"/> (default) the source is interpreted as little-endian; if <see langword="true"/> it is interpreted as big-endian.</param>
        /// <returns>The value read from the array.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UInt32Le ReadFrom(byte[] source, int offset = 0, bool isBigEndian = false) => new(new ReadOnlySpan<byte>(source), offset, isBigEndian);
