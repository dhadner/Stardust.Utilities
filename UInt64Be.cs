...
namespace Stardust.Utilities
{
                              ...
                              IFormattable, ISpanFormattable, IParsable<UInt64Be>, ISpanParsable<UInt64Be>
    {
        ...
        /// <summary>
        /// Creates a big-endian 64-bit unsigned integer from a ReadOnlySpan whose byte order is specified.
        /// </summary>
        /// <param name="bytes">Source span (must have at least 8 bytes).</param>
        ...
        /// <exception cref="ArgumentException">If span is too short.</exception>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt64Be(ReadOnlySpan<byte> bytes, bool isBigEndian = true)
        {
            if (bytes.Length < 8)
            {
                throw new ArgumentException("Span must have at least 8 bytes", nameof(bytes));
        ...
        /// <summary>
        /// Creates a big-endian 64-bit unsigned integer from a ReadOnlySpan at the given offset.
        /// </summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public UInt64Be(ReadOnlySpan<byte> bytes, int offset, bool isBigEndian = true)
        {
        ...
        /// <summary>
        /// Creates a big-endian 64-bit unsigned integer from a byte array whose byte order is specified.
        /// </summary>
        ...
        public UInt64Be(byte[] bytes, bool isBigEndian = true) : this(new ReadOnlySpan<byte>(bytes), isBigEndian) { }

        /// <summary>
        /// Creates a big-endian 64-bit unsigned integer from a byte array at the given offset.
        /// </summary>
        ...
        /// <param name="isBigEndian">If <see langword="true"/> (default) the source is interpreted as big-endian; if <see langword="false"/> it is interpreted as little-endian and reversed during storage.</param>
        /// <exception cref="ArgumentException">If array is too short.</exception>
        public UInt64Be(byte[] bytes, int offset, bool isBigEndian = true) : this(new ReadOnlySpan<byte>(bytes), offset, isBigEndian) { }
        ...
        public readonly void ToBytes(IList<byte> bytes, int offset = 0, bool isBigEndian = true)
        {
            if (isBigEndian)
            {
                ...
                WriteTo(buf, 0, isBigEndian: true);
                for (int i = 0; i < 8; i++) bytes[offset + i] = buf[i];
            }
            else
            {
                Span<byte> buf = stackalloc byte[8];
        ...
        /// </summary>
        /// <param name="destination">Destination span (must have at least 8 bytes starting from <paramref name="offset"/>).</param>
        ...
        [Obsolete("IList<byte> overloads are deprecated. Use WriteTo(ulong, Span<byte>) instead.")]
        ...
        /// <summary>
        /// Reads a <see cref="UInt64Be"/> from a ReadOnlySpan in the specified byte order.
        /// </summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UInt64Be ReadFrom(ReadOnlySpan<byte> source, int offset = 0, bool isBigEndian = true) => new(source, offset, isBigEndian);

        /// <summary>
        /// Reads a <see cref="UInt64Be"/> from a byte array in the specified byte order.
        /// </summary>
        ...
        /// <returns>The parsed value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static UInt64Be ReadFrom(byte[] source, int offset = 0, bool isBigEndian = true) => new(new ReadOnlySpan<byte>(source), offset, isBigEndian);
