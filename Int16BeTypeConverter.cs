...
{
    /// <summary>
    /// Used to support PropertyGrid editing of <see cref="Int16Be"/>.
    ...
    /// </summary>
    public class Int16BeTypeConverter : TypeConverter
    {
        private static readonly StandardValuesCollection STANDARD_VALUES =
            new(new Int16Be[] { new(short.MinValue), new((short)0), new(short.MaxValue) });
        ...
        /// <summary>
        /// Converts the given value to an <see cref="Int16Be"/> instance.
        /// </summary>
        /// <param name="context">Context information.</param>
        /// <param name="culture">Culture information (used for decimal parsing).</param>
        /// <param name="value">The value to convert.</param>
        /// <returns>The converted <see cref="Int16Be"/>.</returns>
        public override object? ConvertFrom(ITypeDescriptorContext? context, CultureInfo? culture, object value)
        {
            if (value is string s)
            {
                return ConverterParsing.Parse<Int16Be>(s, culture,
                    (d, p) => Int16Be.Parse(d, p),
                    h => Int16Be.Parse(h, NumberStyles.HexNumber));
            }
            if (value is short i) return new Int16Be(i);
                                          ...
                                          object? value, Type destinationType)
        {
            if (destinationType == typeof(string))
            {
                ...
                if (value is Int16Be v) return $"0x{(ushort)(short)v:x4}";
            }
            if (destinationType == typeof(short) && value is Int16Be v2) return (short)v2;
            if (destinationType == typeof(InstanceDescriptor) && value is Int16Be v3)
            {
                ConstructorInfo ctor = typeof(Int16Be).GetConstructor(new[] { typeof(short) })!;
        ...
        {
            if (value is Int16Be) return true;
            if (value is short) return true;
            if (value is string s)
            {
                return ConverterParsing.TryParse<Int16Be>(s, null,
                    (d, p) => Int16Be.Parse(d, p),
                    h => Int16Be.Parse(h, NumberStyles.HexNumber),
                    out _);
            }
