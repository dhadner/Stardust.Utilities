...
namespace Stardust.Utilities
{
    ...
    /// </summary>
    [Serializable]
    [TypeConverter(typeof(Int16BeTypeConverter))]
                             ...
                             IFormattable, ISpanFormattable, IParsable<Int16Be>, ISpanParsable<Int16Be>
    {
        ...
        // register. On LE hosts, _value reads bytes [hi, lo] as a native short,
        ...
        /// <summary>
        /// Creates a big-endian 16-bit signed integer from a ReadOnlySpan at the given offset.
        /// </summary>
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Int16Be(ReadOnlySpan<byte> bytes, int offset, bool isBigEndian = true)
        {
        ...
        /// <summary>
        /// Creates a big-endian 16-bit signed integer from a byte array whose byte order is specified.
        /// </summary>
        ...
        public Int16Be(byte[] bytes, bool isBigEndian = true) : this(new ReadOnlySpan<byte>(bytes), isBigEndian) { }

        /// <summary>
        /// Creates a big-endian 16-bit signed integer from a byte array at the given offset.
        /// </summary>
        ...
        /// <param name="isBigEndian">If <see langword="true"/> (default) the source is interpreted as big-endian; if <see langword="false"/> it is interpreted as little-endian and reversed during storage.</param>
        /// <exception cref="ArgumentException">If array is too short.</exception>
        public Int16Be(byte[] bytes, int offset, bool isBigEndian = true) : this(new ReadOnlySpan<byte>(bytes), offset, isBigEndian) { }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Int16Be ReadFrom(ReadOnlySpan<byte> source, int offset = 0, bool isBigEndian = true) => new(source, offset, isBigEndian);

        /// <summary>
        /// Reads an <see cref="Int16Be"/> from a byte array in the specified byte order.
        /// </summary>
        ...
        /// <returns>The parsed value.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static Int16Be ReadFrom(byte[] source, int offset = 0, bool isBigEndian = true) => new(new ReadOnlySpan<byte>(source), offset, isBigEndian);
