...
{
    [BitField(0, End = 7, Description = "Condition Code Register")]
    public partial M68020CCR CCR { get; set; }

    [BitField(8, End = 10, Description = "Interrupt priority mask (0-7)")]
...
{
    [BitField(0, End = 2, Description = "Source function code")]
...
{
    [BitField(0, End = 2, Description = "Destination function code")]
    public partial byte FC { get; set; }
}
...
{
    [BitField(0, End = 31, Description = "Program Counter")]
...
{
    [BitField(0, End = 31, Description = "Vector Base Register")]
...
{
    [BitField(0, End = 31, Description = "Cache Address Register")]
...
{
    [BitField(0, End = 31, Description = "A7* (Master Stack Pointer)")]
...
{
    [BitField(0, End = 31, Description = "A7* (Interrupt Stack Pointer)")]
...
{
    [BitField(0, End = 31, Description = "A7 (User Stack Pointer)")]
...
{
    [BitField(0, End = 31, Description = "Data register 0")] public partial uint D0 { get; set; }
    [BitField(32, End = 63, Description = "Data register 1")] public partial uint D1 { get; set; }
    [BitField(64, End = 95, Description = "Data register 2")] public partial uint D2 { get; set; }
    [BitField(96, End = 127, Description = "Data register 3")] public partial uint D3 { get; set; }
    [BitField(128, End = 159, Description = "Data register 4")] public partial uint D4 { get; set; }
    [BitField(160, End = 191, Description = "Data register 5")] public partial uint D5 { get; set; }
    [BitField(192, End = 223, Description = "Data register 6")] public partial uint D6 { get; set; }
    [BitField(224, End = 255, Description = "Data register 7")] public partial uint D7 { get; set; }
}
...
{
    [BitField(0, End = 31, Description = "Address register 0")] public partial uint A0 { get; set; }
    [BitField(32, End = 63, Description = "Address register 1")] public partial uint A1 { get; set; }
    [BitField(64, End = 95, Description = "Address register 2")] public partial uint A2 { get; set; }
    [BitField(96, End = 127, Description = "Address register 3")] public partial uint A3 { get; set; }
    [BitField(128, End = 159, Description = "Address register 4")] public partial uint A4 { get; set; }
    [BitField(160, End = 191, Description = "Address register 5")] public partial uint A5 { get; set; }
    [BitField(192, End = 223, Description = "Address register 6 (often used as a Frame Pointer)")] public partial uint A6 { get; set; }
}
